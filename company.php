...
<div class="about-intro-wrap pull-left">
  ...
  <div class="bread-heading"><h1>Oferta Academica Compa&Ntilde;ias</h1></div>                        
  </div>
  </div>
  </div> 
</div>
...
do { ?>
  ...
  <img alt="<?php echo $row_catego['strTitulo']; ?>" src="imagenes/oferta_company/<?php echo $row_catego['txtImagen_Peq']; ?>" class="img-responsive" />
  </div>
    
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
  <div class="blog-box-title"><?php echo $row_catego['strTitulo']; ?></div>
  <p><a href="ver_company_oferta-<?php echo RemUrl($row_catego['strTitulo']); ?>_<?php echo $row_catego['idCompanias']; ?>" class="inner-page-butt-blue large-but">Informaci&Oacute;n</a></p>
  </div>
  ...
  <?php if ($cuen == 2) { ?><div class="clearfix"></div><?php } if ($cuen == 5) { ?><div class="clearfix"></div><?php }if ($cuen == 8) { ?><div class="clearfix"></div><?php } $cuen = $cuen + 1;} while ($row_catego = mysql_fetch_assoc($catego)); ?>    
  </div>
  </div>
</div>
<br>
