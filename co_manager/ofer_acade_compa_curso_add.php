...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_company_objetivos (strObjetivo, intOferta_Company, intEstado) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['strObjetivo'], "text"),
                       GetSQLValueString($_POST['intOferta_Company'], "int"),
                       GetSQLValueString($_POST['intEstado'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ofer_acade_compa_curso.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Agregando un nuevo Curso</h3>
<br><br>
<a href="ofer_acade_compa_curso.php?id=<?php echo $_GET['id']; ?>" class="btn btn-white btn-icon btn-icon-standalone btn-sm"><i class="fa-reply"></i><span>Regresar</span></a>
</div>
<div class="panel-body">
  ...
  <input name="strObjetivo" type="text" class="form-control" id="strObjetivo" />
  </div>
  </div>
  </div>
  ...
  <button type="submit" class="btn btn-success">Agregar</button>
    ...
    <input type="hidden" name="intOferta_Company" value="<?php echo $_GET['id']; ?>">
