...
$query_verifi = sprintf("SELECT * FROM tbloferta_company WHERE tbloferta_company.idOferta = %s", GetSQLValueString($var_verifi, "int"));
...
$direccion = ("../imagenes/oferta_company/");

unlink ($direccion.$archivo1);
unlink ($direccion.$archivo2);

  $deleteSQL = sprintf("DELETE FROM tbloferta_company WHERE idOferta=%s",
