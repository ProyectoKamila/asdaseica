...
$query_redes_sociales = "SELECT * FROM tblredes_sociales";
...
<h3 class="panel-title">Todas las Redes Sociales</h3>
</div>
...
<?php do { ?>
<h2 class="no-top-margin"><?php echo $row_redes_sociales['strTitulo']; ?></h2>
<p><?php echo $row_redes_sociales['txtUrl']; ?></p><br>
<p>Estado: <?php echo ObtEsta($row_redes_sociales['intEstado']); ?></p><br>
<a class="btn btn-success btn-icon btn-icon-standalone" href="pag_redes_sociales_edit.php?id=<?php echo $row_redes_sociales['idRed']; ?>">
<i class="fa-plus"></i><span>Editar</span></a>
<br />
<br />
<?php } while ($row_redes_sociales = mysql_fetch_assoc($redes_sociales)); ?>
