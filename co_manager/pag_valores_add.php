...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblsomos_valores (strTitulo, txtTexto, txtImagen, intEstado) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_conexion, $conexion);
$query_valores = "SELECT * FROM tblsomos_valores ORDER BY tblsomos_valores.idValores DESC";
