...
<h3 class="panel-title">Agregando a la Lista y Enviado Correo de Pago</h3>
</div>
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $insertSQL = sprintf("INSERT INTO tblcursos_aseica_participantes (intCurso, intPaticiapante, intCalendario, intEstado) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($row_registro['intOferta'], "int"),
                       GetSQLValueString($row_registro['idPre_inscripcion'], "int"),
                       GetSQLValueString($row_registro['intCalendario'], "int"),
...
<p style="text-align: justify;">Con gusto le informamos que su cupo en el Curso de '.$oferta_Seleccionada.' ha sido reservado. Para formalizar el proceso de inscripción, necesitamos haga usted lo siguiente:</p>
';

if ($carta_compromiso == 1 ) {

$mensaje .= '
<p style="text-align: justify;">1. Efectúe un depósito en efectivo por la cantidad de '.$costo.' en la Cuenta Corriente del Banco de Venezuela Nro. 0102-0405-12-0000112040 a nombre de la ACADEMIA DE SERVICIOS EDUCATIVOS INTEGRALES C.A. ,  R.I.F. J-29560193-0</p>

<p style="text-align: justify;">2. Escriba el número del depósito o transferencia en el enlace <a href="http://www.aseica.com.ve/validar_pago.php?id='.$numr.'&parti='.$numr2.'&pa='.$id_Pre_inscrip.'&cle0='.$row_registro['intOferta'].'">NOTIFICASIÓN DE PAGO</a></p>

<p style="text-align: justify;">3. Una vez confirmado el depósito, volveremos a establecer contacto con usted.</p>

<p style="text-align: justify;">No se aceptan pagos en efectivo en nuestra sede.</p>

<p style="text-align: justify;">¡Nuevamente gracias y b'.$sexo2.'!</p>
';
}

if ($carta_compromiso == 2 ) {

$mensaje .= '
<p style="text-align: justify;">1. Efectúe una transferencia bancaria por la cantidad de '.$costo.' en la Cuenta Corriente del Banco de Venezuela Nro. 0102-0405-12-0000112040 a nombre de la ACADEMIA DE SERVICIOS EDUCATIVOS INTEGRALES C.A. ,  R.I.F. J-29560193-0</p>

<p style=”text-align: justify;”>2. Escriba el número del depósito o transferencia en el enlace <a href="http://www.aseica.com.ve/pago.php?id='.$numr.'&parti='.$numr2.'&pa='.$id_Pre_inscrip.'&cle0='.$row_registro['intOferta'].'">NOTIFICACIÓN DE PAGO</a></p>

<p style="text-align: justify;">3. Recuerde que las transferencias efectuadas desde bancos distintos al destinatario, requieren de veinticuatro (24) horas para hacerse efectivas cuando se realizan después de las 10:00 am, por otra parte, las efectuadas los días viernes en horario posterior al indicado, se harán efectivas el día hábil siguiente.</p>

<p style="text-align: justify;">4. Una vez confirmada la transferencia, volveremos a establecer contacto con usted.</p>

<p style="text-align: justify;">¡Nuevamente gracias y b'.$sexo2.'!</p>
';
}

if ($carta_compromiso == 3 ) {

$mensaje .= '
<p style="text-align: justify;">1. Solicite al Departamento correspondiente de su empresa una Carta de Compromiso con sellos húmedos dirigida a ACADEMIA DE SERVICIOS EDUCATIVOS INTEGRALES C.A., R.I.F. J-29560193-0.</p>

<p style="text-align: justify;">2. Entregue el original a nuestra Dirección Académica ubicada en el piso nro. 17 de la Torre Polar Este, Plaza Venezuela Caracas 1080.</p>
';
}
...
<META HTTP-EQUIV="Refresh" CONTENT="3; URL=infor_natural.php">
