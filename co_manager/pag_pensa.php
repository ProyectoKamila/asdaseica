...
$query_pensamiento = "SELECT * FROM tblpensamiento";
...
<h3 class="panel-title">Lista de los Pensamientos</h3>
</div>
...
<?php do { ?>
<h2 class="no-top-margin"><?php echo $row_pensamiento['strTitulo']; ?></h2>
<p><?php echo $row_pensamiento['txtParrafo']; ?></p><br>
<p>Estado: <?php echo ObtEsta($row_pensamiento['intEstado']); ?></p><br>
<a class="btn btn-success btn-icon btn-icon-standalone" href="pag_pensa_edit.php?id=<?php echo $row_pensamiento['idPensamiento']; ?>">
<i class="fa-plus"></i><span>Editar</span></a>
<br />
<br />
<?php } while ($row_pensamiento = mysql_fetch_assoc($pensamiento)); ?>
</div>
