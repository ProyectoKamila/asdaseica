...
$query_areas = "SELECT * FROM tbloferta_area ORDER BY tbloferta_area.strDescripcion";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_area (strDescripcion) VALUES (%s)",
                       GetSQLValueString($_POST['strDescripcion'], "text"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ofer_acade_areas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Listas de las Areas</h3>
</div>
...
<?php do { ?>
<tr>
  <td><?php echo $row_areas['idArea']; ?></td>
<td><?php echo $row_areas['strDescripcion']; ?></td>
<td><a href="ofer_acade_areas_edit.php?id=<?php echo $row_areas['idArea']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="ofer_acade_areas_del.php?id=<?php echo $row_areas['idArea']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
</tr>
...
<label class="col-sm-2 control-label" for="strDescripcion">Nueva Area</label>
<div class="col-sm-6">
<input name="strDescripcion" type="text" class="form-control" id="strDescripcion" placeholder="Ingresa Una Descripcion">
</div>
</div>
