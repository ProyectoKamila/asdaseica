...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE tbloferta_modalidad SET strModalidad=%s WHERE idModalidad=%s",
  ...
  $updateGoTo = "ofer_acade_modal.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$var_modalidad = "0";
if (isset($_GET['id'])) {
  $var_modalidad = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_modalidad = sprintf("SELECT * FROM tbloferta_modalidad WHERE tbloferta_modalidad.idModalidad = %s", GetSQLValueString($var_modalidad, "int"));
...
<h3 class="panel-title">Edici&oacute;n de las Modalidades</h3>
</div>
...
<?php include("includes/menu_oferta.php"); ?>
</ul>
</div>
<!-- /.navbar-collapse -->
</nav>
...
<label class="col-sm-2 control-label" for="strModalidad">EditandoModalidad de Evento</label>
<div class="col-sm-6">
<input name="strModalidad" type="text" class="form-control" id="strModalidad" value="<?php echo htmlentities($row_modalidad['strModalidad'], ENT_COMPAT, 'utf-8'); ?>" >
</div>
</div>
...
<button type="submit" class="btn btn-success">Actualizar</button>
  ...
  <input type="hidden" name="idModalidad" value="<?php echo $row_modalidad['idModalidad']; ?>">
</form>
