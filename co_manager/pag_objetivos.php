...
$query_objetivos = "SELECT * FROM tblobjetivos_titu ORDER BY tblobjetivos_titu.idObjetivo ";
...
<h3 class="panel-title">Lista de Objetivos</h3><br><br>
<a href="pag_objetivos_add.php" class="btn btn-success">Agregar Nuevo Objetivo</a>
</div>
...
<th data-priority="3">Parrafo Corto</th>
<th data-priority="2">Imagen</th>
<th data-priority="3">Lista</th>
...
<?php do { ?>
  <tr>
    <th><?php echo $row_objetivos['strTutulo']; ?></th>
    <td><?php echo $row_objetivos['idObjetivo']; ?></td>
    <td><?php echo $row_objetivos['txtPar_Cor']; ?></td>
    <td><?php echo $row_objetivos['txtImagen']; ?></td>
    <td><ol>
      <?php
	  mysql_select_db($database_conexion, $conexion);
	  $query_listas = sprintf("SELECT * FROM tblobjetivos_lista WHERE tblobjetivos_lista.intObj_titu = %s", $row_objetivos['idObjetivo']);
	  ...
	  do { ?>
      <li><?php echo $row_listas['strObjetivo']; ?></li>
	  <?php } while ($row_listas = mysql_fetch_assoc($listas)); ?>

    </ol></td>
    <td><?php echo $row_objetivos['intEstado']; ?></td>
    <td><a class="btn btn-icon btn-warning" href="pag_objetivos_edit.php?obj=<?php echo $row_objetivos['idObjetivo']; ?>"><i class="fa-edit"></i></a>
    <a href="pag_objetivos_dell.php?obj=<?php echo $row_objetivos['idObjetivo']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
  </tr>
