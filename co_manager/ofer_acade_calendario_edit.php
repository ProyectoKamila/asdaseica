...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbloferta_academica_calendario SET intMes=%s, intAno=%s, datFecha_01=%s, datFecha_02=%s, datFecha_03=%s, datFecha_04=%s, datFecha_05=%s, datFecha_06=%s, intEstado=%s WHERE idCalendario=%s",
  ...
  $updateGoTo = "ofer_acade_calendario.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="panel-body">
  ...
  <select name="intMes" class="form-control">
    <option value="01" <?php if (!(strcmp(01, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Enero</option>
    <option value="02" <?php if (!(strcmp(02, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Febrero</option>
    <option value="03" <?php if (!(strcmp(03, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Marzo</option>
    <option value="04" <?php if (!(strcmp(04, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Abril</option>
    <option value="05" <?php if (!(strcmp(05, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Mayo</option>
    <option value="06" <?php if (!(strcmp(06, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Junio</option>
    <option value="07" <?php if (!(strcmp(07, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Julio</option>
    <option value="08" <?php if (!(strcmp(08, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Agosto</option>
    <option value="09" <?php if (!(strcmp(09, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Septiembre</option>
    <option value="10" <?php if (!(strcmp(10, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Octubre</option>
    <option value="11" <?php if (!(strcmp(11, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Noviembre</option>
    <option value="12" <?php if (!(strcmp(12, $row_calendario['intMes']))) {echo "selected=\"selected\"";} ?>>Diciembre</option>
  </select>
  </div>
...
$i = $ano; $fi = $ano + 5;
do { ?>
    <option value="<?php echo $i; ?>" <?php if (!(strcmp($i, $row_calendario['intAno']))) {echo "selected=\"selected\"";} ?>><?php echo $i; ?></option>
...
?>
  ...
  <input name="datFecha_01" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_01']; ?>" data-format="yyyy-mm-dd">
  ...
  <div class="col-sm-3">
  <div class="input-group">
  <input name="datFecha_02" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_02']; ?>" data-format="yyyy-mm-dd">
  <a href="#"><i class="linecons-calendar"></i></a>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-3">
  <div class="input-group">
  <input name="datFecha_03" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_03']; ?>" data-format="yyyy-mm-dd">
  <a href="#"><i class="linecons-calendar"></i></a>
  </div>
  </div>
  ...
  <div class="col-sm-3">
  <div class="input-group">
  <input name="datFecha_04" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_04']; ?>" data-format="yyyy-mm-dd">
  <a href="#"><i class="linecons-calendar"></i></a>
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-3">
  <div class="input-group">
  <input name="datFecha_05" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_05']; ?>" data-format="yyyy-mm-dd"><a href="#"><i class="linecons-calendar"></i></a>
  </div>
  </div>
  ...
  <div class="col-sm-3">
  <div class="input-group">
  <input name="datFecha_06" type="text" class="form-control datepicker" value="<?php echo $row_calendario['datFecha_06']; ?>" data-format="yyyy-mm-dd"><a href="#"><i class="linecons-calendar"></i></a>
  </div>
  </div>
  </div>
