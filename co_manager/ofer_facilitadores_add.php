...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblfacilitadores (strNombre, txtInformacion, intEstado) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "ofer_facilitadores_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Agregar Nuevo Facilitador</h3>
</div>
...
<div class="col-sm-10">
<textarea name="txtInformacion" cols="5" class="form-control" id="txtInformacion"></textarea>
</div>
</div>
