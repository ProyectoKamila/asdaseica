...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblcursos_aseica SET strFolio=%s, strLibro=%s, txtInfor_Extra=%s, intEstado=%s WHERE idCurso=%s",
...
mysql_select_db($database_conexion, $conexion);
$query_curso = sprintf("SELECT * FROM tblcursos_aseica WHERE tblcursos_aseica.idCurso = %s", GetSQLValueString($var_curso, "int"));
...
mysql_select_db($database_conexion, $conexion);
$query_facilitador = "SELECT * FROM tblfacilitadores WHERE tblfacilitadores.intEstado = 1";
...
<h3 class="panel-title">Editando el Curso</h3>
</div>
...
<input name="strFolio" type="text" class="form-control" id="strFolio" value="<?php echo htmlentities($row_curso['strFolio'], ENT_COMPAT, 'utf-8'); ?>"/>
</div>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label" for="strLibro">Libro Curso</label>
<div class="col-sm-4">
<div class="input-group">
<span class="input-group-addon"><i class="fa-pie-chart"></i></span>
<input name="strLibro" type="text" class="form-control" id="strLibro" value="<?php echo htmlentities($row_curso['strLibro'], ENT_COMPAT, 'utf-8'); ?>"/>
</div>
</div>
</div>
...
<div class="col-sm-9">
<textarea name="txtInfor_Extra" cols="5" class="form-control" id="txtInfor_Extra"><?php echo htmlentities($row_curso['txtInfor_Extra'], ENT_COMPAT, 'utf-8'); ?></textarea>
</div>
</div>
...
<option value="1" <?php if (!(strcmp(1, htmlentities($row_curso['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "selected=\"selected\"";} ?>>Activo</option>
<option value="0" <?php if (!(strcmp(0, htmlentities($row_curso['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "selected=\"selected\"";} ?>>Desactivado</option>
<option value="3" <?php if (!(strcmp(3, htmlentities($row_curso['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "selected=\"selected\"";} ?>>Finalizado</option>
</select>
</div>
</div>
...
<input type="hidden" name="idCurso" value="<?php echo $row_curso['idCurso']; ?>">
</form>
