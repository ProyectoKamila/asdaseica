...
$obejt = $_POST['intObj_titu'];

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblobjetivos_lista (intObj_titu, strObjetivo) VALUES (%s, %s)",
                       GetSQLValueString($obejt, "int"),
                       GetSQLValueString($_POST['strObjetivo'], "text"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "pag_objetivos_edit_2.php?obj=".$obejt;
  if (isset($_SERVER['QUERY_STRING'])) {
...
<?php if ($totalRows_verifi > 0) { // Show if recordset not empty ?>
<a href="pag_objetivos_edit.php?obj=<?php echo $_GET['obj']; ?>" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<label class="col-sm-2 control-label" for="strObjetivo">Objetivo</label>

<div class="col-sm-10">
<textarea name="strObjetivo" cols="5" class="form-control" id="strObjetivo"></textarea>
</div>
</div>
...
<input type="hidden" name="intObj_titu" value="<?php echo $_GET['obj']; ?>">
...
<th><a href="pag_objetivos_edit_3.php?lis=<?php echo $row_verifi['idLista']; ?>&obj=<?php echo $_GET['obj']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></th>
</tr>
