...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblcontacto SET strTelefono_01=%s, strTelefono_02=%s, strEmail_01=%s, strEmail_02=%s, strHorario=%s, txtLatitud=%s, strLongitud=%s, txtDireccion=%s, txtParrafoCorto=%s WHERE idContacto=%s",
                       ...
                       GetSQLValueString($_POST['txtLatitud'], "text"),
                       GetSQLValueString($_POST['strLongitud'], "text"),
                       GetSQLValueString($_POST['txtDireccion'], "text"),
                       GetSQLValueString($_POST['txtParrafoCorto'], "text"),
...
mysql_select_db($database_conexion, $conexion);
$query_contacto = "SELECT * FROM tblcontacto";
$contacto = mysql_query($query_contacto, $conexion) or die(mysql_error());
...
<div class="title-env">
<h1 class="title">P&aacute;gina Contacto</h1>
<p class="description">Elementos dentro de esta Pagina</p>
</div>
<!-- InstanceEndEditable -->
...
<h3 class="panel-title">Elementos en Contacto</h3>
</div>
...
<div class="col-sm-10">
<input name="strTelefono_01" type="text" class="form-control" id="strTelefono_01" value="<?php echo $row_contacto['strTelefono_01']; ?>">
</div>
</div>
...
<div class="col-sm-10">
<input name="strTelefono_02" type="text" class="form-control" id="strTelefono_02" value="<?php echo $row_contacto['strTelefono_02']; ?>">
</div>
</div>
...
<div class="col-sm-10">
<input name="strEmail_01" type="text" class="form-control" id="strEmail_01" value="<?php echo $row_contacto['strEmail_01']; ?>">
</div>
</div>
...
<div class="col-sm-10">
<input name="strEmail_02" type="text" class="form-control" id="strEmail_02" value="<?php echo $row_contacto['strEmail_02']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strHorario">Horario</label>
<div class="col-sm-10">
<input name="strHorario" type="text" class="form-control" id="strHorario" value="<?php echo $row_contacto['strHorario']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtLatitud">Latitud Mapa</label>
<div class="col-sm-10">
<input name="txtLatitud" type="text" class="form-control" id="txtLatitud" value="<?php echo $row_contacto['txtLatitud']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strLongitud">Longitud Mapa</label>
<div class="col-sm-10">
<input name="strLongitud" type="text" class="form-control" id="strLongitud" value="<?php echo $row_contacto['strLongitud']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtDireccion">Direcci&oacute;n: </label>
<div class="col-sm-10">
<textarea name="txtDireccion" cols="5" class="form-control" id="txtDireccion"><?php echo $row_contacto['txtDireccion']; ?></textarea>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="TxtParrafoCorto">Parrafo Corto: </label>
<div class="col-sm-10">
<textarea name="TxtParrafoCorto" cols="5" class="form-control" id="TxtParrafoCorto"><?php echo $row_contacto['TxtParrafoCorto']; ?></textarea>
</div>
</div>
