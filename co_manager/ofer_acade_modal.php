...
$query_modali = "SELECT * FROM tbloferta_modalidad ORDER BY tbloferta_modalidad.strModalidad";
$modali = mysql_query($query_modali, $conexion) or die(mysql_error());
$row_modali = mysql_fetch_assoc($modali);
$totalRows_modali = mysql_num_rows($modali);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_modalidad (strModalidad) VALUES (%s)",
                       GetSQLValueString($_POST['strModalidad'], "text"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ofer_acade_modal.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Listas de las Modalidades</h3>
</div>
...
<?php do { ?>
  <tr>
    <th><?php echo $row_modali['idModalidad']; ?></th>
    <th><?php echo $row_modali['strModalidad']; ?></th>
    <th><a href="ofer_acade_modal_edit.php?id=<?php echo $row_modali['idModalidad']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="ofer_acade_modal_del.php?id=<?php echo $row_modali['idModalidad']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></th>
  </tr>
  <?php } while ($row_modali = mysql_fetch_assoc($modali)); ?>
</tbody>
</table>
</div>
...
<label class="col-sm-2 control-label" for="strModalidad">Modalidad de Evento</label>
<div class="col-sm-6">
<input name="strModalidad" type="text" class="form-control" id="strModalidad" placeholder="Ingresa Una Descripcion">
</div>
</div>
