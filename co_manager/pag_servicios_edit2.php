...
mysql_select_db($database_conexion, $conexion);
$query_valores = sprintf("SELECT * FROM tblservicios WHERE tblservicios.idValores = %s", GetSQLValueString($var_valores, "int"));
...
<div class="col-sm-6">
<img src="../imagenes/servicios/<?php echo $row_valores['txtImagen']; ?>" class="img-responsive" >
</div>
</div>
...
<label class="col-sm-2 control-label" for="txtImagen">Imagen Descriptiva</label>
<div class="col-sm-6">
<input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo htmlentities($row_valores['txtImagen'], ENT_COMPAT, 'utf-8'); ?><?php echo htmlentities($row_valores['txtImagen'], ENT_COMPAT, 'utf-8'); ?>" >
</div>
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'servicios', '<?php echo $row_valores['idValores']; ?>', '<?php echo $row_valores['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
