...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblinfo_principal SET strTitulo=%s, txtImagen=%s, txtParrafo=%s, intEstado=%s WHERE idInfo=%s",
                       GetSQLValueString($_POST['strTitulo'], "text"),
                       GetSQLValueString($_POST['txtImagen'], "text"),
                       GetSQLValueString($_POST['txtParrafo'], "text"),
...
mysql_select_db($database_conexion, $conexion);
$query_info = "SELECT * FROM tblinfo_principal";
...
<p class="description">Informacion pagina Inicio</p>
</div>
<!-- InstanceEndEditable -->
...
<h3 class="panel-title">Editando la Informacion de Inicio</h3>
</div>
<div class="panel-body"> Contenido Pagina
  ...
  <input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo htmlentities($row_info['strTitulo'], ENT_COMPAT, 'utf-8'); ?>" />
  </div>
  </div>
  </div>
  ...
  <img src="../imagenes/logo/<?php echo $row_info['txtImagen']; ?>" class="img-responsive">
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-6">
    <input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo htmlentities($row_info['txtImagen'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'logo', '<?php echo $row_info['idInfo']; ?>', '<?php echo $row_info['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtParrafo">Parrafo</label>
  <div class="col-sm-10">
    <textarea name="txtParrafo" cols="5" class="form-control" id="txtParrafo"><?php echo htmlentities($row_info['txtParrafo'], ENT_COMPAT, 'utf-8'); ?></textarea>
  </div>
  </div>
  ...
  <option value="1" <?php if (!(strcmp(1, htmlentities($row_info['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Activo</option>
  <option value="0" <?php if (!(strcmp(0, htmlentities($row_info['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Desactivado</option>
  </select>
  </div>
  </div>
  </div> 
  ...
  <button type="submit" class="btn btn-success">Actualizar</button>
    ...
    <input type="hidden" name="idInfo" value="<?php echo $row_info['idInfo']; ?>">
  </form>
