...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE tbloferta_area SET strDescripcion=%s WHERE idArea=%s",
  ...
  $updateGoTo = "ofer_acade_areas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_areas = sprintf("SELECT * FROM tbloferta_area WHERE tbloferta_area.idArea = %s", GetSQLValueString($var_areas, "int"));
...
<h3 class="panel-title">Editando las Areas</h3>
</div>
...
<label class="col-sm-2 control-label" for="strTipo">Editando Area</label>
<div class="col-sm-6">
<input name="strDescripcion" type="text" class="form-control" id="strDescripcion" value="<?php echo $row_areas['strDescripcion']; ?>" >
</div>
</div>
