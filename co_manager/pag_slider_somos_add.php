...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblslider_somos (strTitulo, intEstilo, txtImagen, txtTexto_01, txtTexto_02, txtTexto_03, txtTexto_04, txtTexto_05, txtTexto_06, txtTexto_07, txtTexto_08, txtTexto_09, txtTexto_10, txtVideo, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "pag_slider_somos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_slider = "SELECT * FROM tblslider_somos ORDER BY tblslider_somos.idSlider DESC";
...
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'slider_somos', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
