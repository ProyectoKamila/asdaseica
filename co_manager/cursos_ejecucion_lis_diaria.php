...
<h3 class="panel-title">Lista de los Participantes Oferta: <?php echo ObtNombOferAcade($_GET['li']); ?>, Fecha: <?php echo FecDelCalen($_GET['cal']); ?></h3>
</div>
...
<div class="sep"></div> 
<?php echo $row_listas['intCurso']; ?>
<h2> 
Imprimir Lista <a href="cursos_ejecucion_lis_diaria_imp.php?li=<?php echo $_GET['li']; ?>&cal=<?php echo $_GET['cal']; ?>" target="_blank"><img src="imagenes/iconos/icono-imprimir.png" width="27" height="27" /></a></h2>
