...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_academica (strTitulo, txtImagen_Peq, intArea, intTipo_Ofer, intModalidad, strDuracion, strHorario, txtDirigido_A, txtObj_Gene, txtObj_Espc_Cont, intFacilitador, intFacilitador2, intFacilitador3, txtInf_Adici, strCosto, txtBeneficios, txtIncluye, txtImagen_01, txtImagen_02, txtImagen_03, txtImagen_04, txtVideo_01, txtVideo_02, txtVideo_03, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_conexion, $conexion);
$query_verifi = "SELECT * FROM tbloferta_academica ORDER BY tbloferta_academica.idOferta DESC";
...
<div class="title-env">
<h1 class="title">Oferta Académica</h1>
...
<div class="row">
  ...
  <h3 class="panel-title">Agregando Nueva Oferta</h3>
  </div>
  ...
  <input name="strTitulo" type="text" class="form-control" id="strTitulo" placeholder="Ingrese el Nombre" />
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="txtImagen_Peq">Imagen Pequeña</label>
  <div class="col-sm-6"><span id="sprytextfield2">
    <input name="txtImagen_Peq" type="text" class="form-control" id="txtImagen_Peq" placeholder="Ingresa Una Imagen">
    <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_Peq', 'oferta_academica', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <input name="strDuracion" type="text" class="form-control" id="strDuracion" />
  </div>
  </div>
  </div>
  ...
  <input name="strHorario" type="text" class="form-control" id="strHorario" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  </div>
  ...
  <textarea name="txtDirigido_A" cols="5" class="form-control" id="txtDirigido_A"></textarea>
  <span class="textareaRequiredMsg">Se necesita un valor.</span><span class="textareaMinCharsMsg">No se cumple el m&iacute;nimo de caracteres requerido.</span></span></div>
  </div>
  ...
  <textarea name="txtObj_Gene" cols="5" class="form-control" id="txtObj_Gene"></textarea>
  <span class="textareaRequiredMsg">Se necesita un valor.</span><span class="textareaMinCharsMsg">No se cumple el m&iacute;nimo de caracteres requerido.</span></span></div>
  </div>
  ...
  <div class="col-sm-9">
  <textarea name="txtObj_Espc_Cont" cols="5" class="form-control" id="txtObj_Espc_Cont"></textarea>
  </div>
  </div>
  ...
  <select name="intFacilitador" class="form-control" >
    ...
    <?php do { ?>
    <option value="<?php echo $row_facilitador1['idFacilitador']?>"><?php echo $row_facilitador1['strNombre']?></option>
    <?php } while ($row_facilitador1 = mysql_fetch_assoc($facilitador1)); 
$rows = mysql_num_rows($facilitador1);
if($rows > 0) {
mysql_data_seek($facilitador1, 0);
$row_facilitador1 = mysql_fetch_assoc($facilitador1);
} ?>
  </select>
  ...
  <option value="">Seleccionar</option>
  <?php do { ?>
  <option value="<?php echo $row_facilitador2['idFacilitador']?>"><?php echo $row_facilitador2['strNombre']?></option>
  <?php
} while ($row_facilitador2 = mysql_fetch_assoc($facilitador2));
$rows = mysql_num_rows($facilitador2);
if($rows > 0) {
mysql_data_seek($facilitador2, 0);
$row_facilitador2 = mysql_fetch_assoc($facilitador2);
} ?>
  </select>
  </div>
  ...
  <option value="">Seleccionar</option>
  <?php do { ?>
  <option value="<?php echo $row_facilitador3['idFacilitador']?>"><?php echo $row_facilitador3['strNombre']?></option>
  <?php
} while ($row_facilitador3 = mysql_fetch_assoc($facilitador3));
$rows = mysql_num_rows($facilitador3);
if($rows > 0) {
mysql_data_seek($facilitador3, 0);
$row_facilitador3 = mysql_fetch_assoc($facilitador3);
}
?>
  </select>
  ...
  <?php do { ?>
  <option value="<?php echo $row_areas['idArea']?>" ><?php echo $row_areas['strDescripcion']?></option>
  ...
  <?php do { ?>
  <option value="<?php echo $row_tipos['idTipo']?>" ><?php echo $row_tipos['strTipo']?></option>
  ...
  <?php do { ?>
  <option value="<?php echo $row_modalidad['idModalidad']?>" ><?php echo $row_modalidad['strModalidad']?></option>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-database"></i></span>
  <input name="strCosto" type="text" class="form-control" id="strCosto" />
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-9">
  <textarea name="txtInf_Adici" cols="5" class="form-control" id="txtInf_Adici"></textarea>
  </div>
  </div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-database"></i></span>
  <input name="txtBeneficios" type="text" class="form-control" id="txtBeneficios" />
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-9">
  <textarea name="txtIncluye" cols="5" class="form-control" id="txtIncluye"></textarea>
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-file-image-o"></i></span><span id="sprytextfield6">
  <input name="txtImagen_01" type="text" class="form-control" id="txtImagen_01" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_01', 'oferta_academica', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <input name="txtImagen_02" type="text" class="form-control" id="txtImagen_02" />
  </div>
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_02', 'oferta_academica', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-file-image-o"></i></span>
  <input name="txtImagen_03" type="text" class="form-control" id="txtImagen_03" />
  </div>
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_03', 'oferta_academica', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-file-image-o"></i></span>
  <input name="txtImagen_04" type="text" class="form-control" id="txtImagen_04" />
  </div>
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_04', 'oferta_academica', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <input name="txtVideo_01" type="text" class="form-control" id="txtVideo_01" />
  </div>
  </div>
  </div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-video-camera"></i></span>
  <input name="txtVideo_02" type="text" class="form-control" id="txtVideo_02" />
  </div>
  </div>
  </div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-video-camera"></i></span>
  <input name="txtVideo_03" type="text" class="form-control" id="txtVideo_03" />
  </div>
  </div>
  </div>
...
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {minChars:100});
var sprytextarea2 = new Spry.Widget.ValidationTextarea("sprytextarea2", {minChars:80});
