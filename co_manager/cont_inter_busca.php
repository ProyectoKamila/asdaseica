...
$var_cont_inter = "0";
if (isset($_GET['busca'])) {
  $var_cont_inter = $_GET['busca'];
}
mysql_select_db($database_conexion, $conexion);
$query_cont_inter = sprintf("SELECT * FROM tblcontacto_interno WHERE tblcontacto_interno.strNombre LIKE %s ORDER BY tblcontacto_interno.idContacto", GetSQLValueString("%" . $var_cont_inter . "%", "text"));
