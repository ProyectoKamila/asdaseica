...
$query_somos = "SELECT * FROM tblsomo_aseica ORDER BY tblsomo_aseica.idSomos";
...
<?php do { ?>
<h2 class="no-top-margin"><?php echo $row_somos['strTitulo']; ?></h2>

<div class="img-container">
<img src="../imagenes/somos/<?php echo $row_somos['txtImagen']; ?>" class="img-responsive" />
</div>

<p><?php echo $row_somos['txtTexto']; ?></p>
<br>
<p>Estado: <?php echo ObtEsta($row_somos['intEstado']); ?></p>
<br>
<a class="btn btn-success btn-icon btn-icon-standalone" href="pag_nosotros_edit.php?id=<?php echo $row_somos['idSomos']; ?>">
<i class="fa-plus"></i><span>Editar</span></a>
<a class="btn btn-red btn-icon btn-icon-standalone" href="pag_nosotros_dell.php?id=<?php echo $row_somos['idSomos']; ?>" onclick="javascript:return asegurar();" >
<i class="fa-plus"></i><span>Eliminar</span></a>
<br />
<br />
<?php } while ($row_somos = mysql_fetch_assoc($somos)); ?>
