...
$query_tipo = "SELECT * FROM tbloferta_tipo ORDER BY tbloferta_tipo.strTipo";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_tipo (strTipo) VALUES (%s)",
                       GetSQLValueString($_POST['strTipo'], "text"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ofer_acade_tipos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Tipos de Cursos Ofrecidos</h3>
</div>
...
<?php do { ?>
  <tr>
    <td><?php echo $row_tipo['strTipo']; ?></td>
    <td><a href="ofer_acade_tipos_edit.php?id=<?php echo $row_tipo['idTipo']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="ofer_acade_tipos_del.php?id=<?php echo $row_tipo['idTipo']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
  </tr>
...
<label class="col-sm-2 control-label" for="strTipo">Tipo de Evento</label>
<div class="col-sm-6">
<input name="strTipo" type="text" class="form-control" id="strTipo" placeholder="Ingresa Una Descripcion">
</div>
</div>
