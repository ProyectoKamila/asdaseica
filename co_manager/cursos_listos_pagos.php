...
<td><a href="javascript:ver('<?php echo $row_listas4['intPaticiapante']; ?>')" class="btn btn-icon btn-warning3"><i class="fa-edit"></i></a></td>
...
<td><a href="cursos_realizar_lista_pago.php?li=<?php echo $row_listas4['intPaticiapante']; ?>" onclick="javascript:return asegurar_pago();" class="btn btn-icon btn-warning2"><i class="fa-edit"></i></a> / <a href="cursos_realizar_lista_pago_error.php?li=<?php echo $row_listas4['intPaticiapante']; ?>" onclick="javascript:return asegurar_error();" class="btn btn-icon btn-warning4"><i class="fa-remove"></i></a></td>
</tr>
