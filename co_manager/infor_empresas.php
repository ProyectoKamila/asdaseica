...
$query_solicitud = "SELECT * FROM tblpre_incrip WHERE tblpre_incrip.intEstado = 3 AND tblpre_incrip.intEmp_Perso = 1 ORDER BY tblpre_incrip.datFecha_Solici";
...
<div class="title-env">
<h1 class="title">Solicitud de Información Empresarial</h1>
...
{
	self.name = 'opener';
	remote = open('infor_empresas_ver.php?id='+id, 'remote', 'width=450, height=650, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes, fullscreen=no, status=yes');
	remote.focus();
}
</script>
...
<h3 class="panel-title">Lista de Empresas Con Información</h3>
...
<div class="panel-body">
    ...
    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
      <thead>
        <tr>
          ...
          <th data-priority="1">Compañia</th>
          <th data-priority="1">Info Solici</th>
          <th data-priority="1">Teléfono 1</th>
          <th data-priority="6">Teléfono 2</th>
          <th data-priority="2">Email 1</th>
          <th data-priority="2">Solicitante</th>
          <th data-priority="3">Email Solicitante</th>
          <th data-priority="3">Teléfono Solicitante</th>
      ...
      <tbody>
        <tr>
          <?php do { ?>
            <tr>
              <th><a href="javascript:ver('<?php echo $row_solicitud['idPre_inscripcion']; ?>')" class="btn btn-icon btn-warning2"><i class="fa-edit"></i></a></th>
              <td><?php echo $row_solicitud['datFecha_Solici']; ?></td>
              <td><?php echo $row_solicitud['strNombre']; ?></td>
              <td><?php echo ObtNombOferEmpre($row_solicitud['intOferta']); ?></td>
              <td><?php echo $row_solicitud['strTelefono_01']; ?></td>
              <td><?php echo $row_solicitud['strTelefono_02']; ?></td>
              <td><?php echo $row_solicitud['strEmail_01']; ?></td>
              <td><?php echo $row_solicitud['strNomb_Respon']; ?> <?php echo $row_solicitud['strApellido_Respon']; ?></td>
              ...
              <td><a href="infor_empresas_edit.php?id=<?php echo $row_solicitud['idPre_inscripcion']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="infor_empresas_dell.php?id=<?php echo $row_solicitud['idPre_inscripcion']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
            </tr>
  ...
  <h3 class="panel-title">No Hay Empresas Con Información</h3>
