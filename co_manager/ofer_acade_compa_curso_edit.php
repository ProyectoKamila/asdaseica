...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbloferta_company_objetivos SET strObjetivo=%s, intEstado=%s WHERE idObjetivo=%s",
  ...
  $updateGoTo = "ofer_acade_compa_curso.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_cursos = sprintf("SELECT * FROM tbloferta_company_objetivos WHERE tbloferta_company_objetivos.idObjetivo = %s", GetSQLValueString($var_cursos, "int"));
...
<div class="title-env">
<h1 class="title">Cursos dento de las ofertas</h1>
...
<div class="panel-body">
  ...
  <label class="col-sm-3 control-label" for="strObjetivo">Nombre del Curso</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-user"></i></span>
  <input name="strObjetivo" type="text" class="form-control" id="strObjetivo" value="<?php echo $row_cursos['strObjetivo']; ?>" />
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="intEstado">Estado del curso</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-certificate"></i></span>
  <select name="intEstado" class="form-control" >
  <option value="1" <?php if (!(strcmp(1, $row_cursos['intEstado']))) {echo "SELECTED";} ?>>Activo</option>
  <option value="0" <?php if (!(strcmp(0, $row_cursos['intEstado']))) {echo "SELECTED";} ?>>Desactivado</option>
  </select>
  </div>
  </div>
  </div>                                
  ...
  <button type="submit" class="btn btn-success">Actualizar</button>
    ...
    <input type="hidden" name="idObjetivo" value="<?php echo $row_cursos['idObjetivo']; ?>">
  </form>
