...
$query_cursos = sprintf("SELECT * FROM tbloferta_company_objetivos WHERE tbloferta_company_objetivos.intOferta_Company = %s", GetSQLValueString($var_cursos, "int"));
...
<h3 class="panel-title">Lista de Cursos en: <?php echo $_GET['id']; ?></h3>
<br><br>
<a href="ofer_acade_compa_curso_add.php?id=<?php echo $_GET['id']; ?>" class="btn btn-success">Agregar Nuevo Curso</a>
</div>
...
<tbody>
  <?php do { ?>
    <tr>
      <td><?php echo $row_cursos['idObjetivo']; ?></td>
      <td><?php echo $row_cursos['strObjetivo']; ?></td>
      <td><?php echo ObtEsta($row_cursos['intEstado']); ?></td>
      <td><a href="ofer_acade_compa_curso_edit.php?id=<?php echo $_GET['id']; ?>&re=<?php echo $row_cursos['idObjetivo']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="ofer_acade_compa_curso_del.php?id=<?php echo $_GET['id']; ?>&re=<?php echo $row_cursos['idObjetivo']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
    </tr>
