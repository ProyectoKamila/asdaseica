...
$query_solicitud = "SELECT * FROM tblpre_incrip WHERE tblpre_incrip.intEstado = 9 ORDER BY tblpre_incrip.datFecha_Solici";
...
{
	self.name = 'opener';
	remote = open('infor_natural_ver.php?id='+id, 'remote', 'width=450, height=650, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes, fullscreen=no, status=yes');
	remote.focus();
}
</script>
    ...
    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
      <thead>
        <tr>
          ...
          <th data-priority="1">Nombre Solicitante</th>
      ...
      <tbody>
          <?php do { ?>
            <tr>
              ...
              <td><?php echo ObtNombOferAcade($row_solicitud['intOferta']); ?><br>
                <?php echo ObtInicOferAcade($row_solicitud['intOferta']); ?>
              </td>
