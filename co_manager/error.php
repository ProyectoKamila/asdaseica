...
<a class="btn btn-white btn-icon btn-icon-standalone btn-icon-standalone-right" href="index.php">
<i class="fa-rotate-left"></i><span>Intentar Nuevamente</span></a> <a class="btn btn-white btn-icon btn-icon-standalone btn-icon-standalone-right" href="error_2.php"><i class="fa-ban"></i><span>Recuperar Contraseña</span></a>
