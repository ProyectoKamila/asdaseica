...
$query_slider = sprintf("SELECT * FROM tblslider_inicio WHERE tblslider_inicio.idSlider = %s", GetSQLValueString($var_slider, "int"));
...
$deleteSQL = sprintf("DELETE FROM tblslider_inicio WHERE idSlider=%s",
...
?>
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=pag_inicio.php">
