...
<h3 class="panel-title">Eliminando Imagenes y Datos</h3>
</div>
<div class="panel-body">

<?php 

$archivo1 = $row_objetivos['txtImagen'];
$direccion = ("../imagenes/objetivos/");
unlink ($direccion.$archivo1);

  $deleteSQL = sprintf("DELETE FROM tblobjetivos_lista WHERE intObj_titu=%s",
                       GetSQLValueString($_GET['obj'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($deleteSQL, $conexion) or die(mysql_error());


  $deleteSQL = sprintf("DELETE FROM tblobjetivos_titu WHERE idObjetivo=%s",
                       GetSQLValueString($_GET['obj'], "int"));
...
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=pag_objetivos.php">
