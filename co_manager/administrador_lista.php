...
$query_tbladministradores = "SELECT * FROM tbladminis ORDER BY tbladminis.strNombre";
...
<p class="description">Lista de los administradores y sus caracter&iacute;sticas </p>
</div>
<!-- InstanceEndEditable -->
...
function asegurar()
{
	rc = confirm("¿Seguro lo desea Eliminar?"); 
	return rc;
}
</script>
...
<h3 class="panel-title">Lista de administradores</h3><br><br>
<a href="administrador_lista_add.php" class="btn btn-success">Agregar Nuevo Administrador</a>
</div>
...
<th data-priority="2">Nivel de Acceso</th>
<th data-priority="3">Entro?</th>
...
<?php do { ?>	
<tr>
<th><?php echo $row_tbladministradores['strNombre']; ?></th>
<td><?php echo $row_tbladministradores['idAdmin']; ?></td>
<td><?php echo $row_tbladministradores['strEmail']; ?></td>
<td><?php echo ObtNivAdmin($row_tbladministradores['intNivel']); ?></td>
<td><?php echo ObtSiNo($row_tbladministradores['intPrimera']); ?></td>
<td><?php echo ObtEsta($row_tbladministradores['intEstado']); ?></td>
<td><a href="administrador_lista_edit.php?id=<?php echo $row_tbladministradores['idAdmin']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="administrador_lista_del.php?id=<?php echo $row_tbladministradores['idAdmin']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
</tr>
<?php } while ($row_tbladministradores = mysql_fetch_assoc($tbladministradores)); ?>
</tbody>
</table>
