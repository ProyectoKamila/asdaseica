...
<div class="row">
  ...
  <h3 class="panel-title"><strong>Formulario 3/4</strong></h3>
...
<h2><span class="let_roja">Las Contrase&ntilde;as No Coinciden</span>, Por favor intenta nuevamente.</h2><br>
<br>
...
<?php } ?>  
  ...
  <label class="col-sm-3 control-label" for="strPass">Nueva Contraseña</label>
  ...
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-key"></i></span><span id="sprytextfield2">
