...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblcontacto_interno SET strNombre=%s, strApellido=%s, strTelefono_01=%s, strTelefono_02=%s, strEmail_01=%s, strEmail_02=%s, strFacebook=%s, strTwitter=%s, strLinkedin=%s, strInstagran=%s, strGooglePlus=%s, strCompania=%s, strCargo=%s, intEstado=%s WHERE idContacto=%s",
...
<h3 class="panel-title">Editando al Contacto</h3>
</div>
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>" class="form-horizontal">
  ...
  <div class="col-sm-6"><span id="sprytextfield1">
    <input name="strNombre" type="text" class="form-control" id="strNombre" value="<?php echo htmlentities($row_contactos['strNombre'], ENT_COMPAT, 'utf-8'); ?>" >
  ...
  <div class="col-sm-6"><span id="sprytextfield2">
    <input name="strApellido" type="text" class="form-control" id="strApellido" value="<?php echo htmlentities($row_contactos['strApellido'], ENT_COMPAT, 'utf-8'); ?>" >
    <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  ...
  <div class="col-sm-6"><span id="sprytextfield3">
    <input name="strTelefono_01" type="text" class="form-control" id="strTelefono_01" value="<?php echo htmlentities($row_contactos['strTelefono_01'], ENT_COMPAT, 'utf-8'); ?>" >
    <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strTelefono_02" type="text" class="form-control" id="strTelefono_02" value="<?php echo htmlentities($row_contactos['strTelefono_02'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strEmail_01" type="text" class="form-control" id="strEmail_01" value="<?php echo htmlentities($row_contactos['strEmail_01'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strEmail_02" type="text" class="form-control" id="strEmail_02" value="<?php echo htmlentities($row_contactos['strEmail_02'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strCompania" type="text" class="form-control" id="strCompania" value="<?php echo htmlentities($row_contactos['strCompania'], ENT_COMPAT, 'utf-8'); ?>">
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strCargo" type="text" class="form-control" id="strCargo" value="<?php echo htmlentities($row_contactos['strCargo'], ENT_COMPAT, 'utf-8'); ?>">
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strFacebook" type="text" class="form-control" id="strFacebook" value="<?php echo htmlentities($row_contactos['strFacebook'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strTwitter" type="text" class="form-control" id="strTwitter" value="<?php echo htmlentities($row_contactos['strTwitter'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strLinkedin" type="text" class="form-control" id="strLinkedin" value="<?php echo htmlentities($row_contactos['strLinkedin'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strInstagran" type="text" class="form-control" id="strInstagran" value="<?php echo htmlentities($row_contactos['strInstagran'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <input name="strGooglePlus" type="text" class="form-control" id="strGooglePlus"value="<?php echo htmlentities($row_contactos['strGooglePlus'], ENT_COMPAT, 'utf-8'); ?>" >
  </div>
  </div>
  ...
  <option value="1" <?php if (!(strcmp(1, htmlentities($row_contactos['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Activo</option>
  <option value="0" <?php if (!(strcmp(0, htmlentities($row_contactos['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Desactivado</option>
  </select>
  </div>
  </div>
  ...
  <button type="reset" class="btn btn-white">Reset</button>
    ...
    <input type="hidden" name="idContacto" value="<?php echo $row_contactos['idContacto']; ?>">
  </form>
