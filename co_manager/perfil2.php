...
<div class="row">
  ...
  <h3 class="panel-title">Cambiar La Respuesta</h3>
  ...
  <h2><span class="let_roja">Las respuestas No Coinciden</span></h2>
  ...
  <label class="col-sm-3 control-label" for="strNombre">Cambiar Respuesta</label>
