...
$archivo1 = $row_verifi['txtImagen_Peq'];
$archivo2 = $row_verifi['txtImagen_01'];
$archivo3 = $row_verifi['txtImagen_02'];
$archivo4 = $row_verifi['txtImagen_03'];
$archivo5 = $row_verifi['txtImagen_04'];

$direccion = ("../imagenes/oferta_academica/");
...
unlink ($direccion.$archivo5);
  ...
  $deleteSQL = sprintf("DELETE FROM tbloferta_academica WHERE idOferta=%s",
...
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=ofer_acade.php">
