...
<h3 class="panel-title">Eliminando Imagenes y Registro</h3>
</div>
<div class="panel-body">

<?php 
$archivo1 = $row_imagen['txtImagen'];
$direccion = ("../imagenes/galeria/");
unlink ($direccion.$archivo1);

$deleteSQL = sprintf("DELETE FROM tblgaleria WHERE idGaleria=%s", GetSQLValueString($_GET['id'], "int"));
...
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=pag_galeria.php">
