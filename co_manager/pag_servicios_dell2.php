...
$query_somos = sprintf("SELECT * FROM tblservicios WHERE tblservicios.idValores = %s", GetSQLValueString($var_somos, "int"));
$somos = mysql_query($query_somos, $conexion) or die(mysql_error());
$row_valores = mysql_fetch_assoc($somos);
...
<div class="panel-heading">Eliminando Imagenes y Registro de <strong><?php echo $row_valores['strTitulo']; ?></strong></div>
<div class="panel-body">

<?php 

$archivo1 = $row_valores['txtImagen'];
$direccion = ("../imagenes/servicios/");
unlink ($direccion.$archivo1);

$deleteSQL = sprintf("DELETE FROM tblservicios WHERE idValores=%s",
