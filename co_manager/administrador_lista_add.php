...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbladminis (strNombre, strEmail, strPass, intNivel, intEstado) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "administrador_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row">
  ...
  <h3 class="panel-title">Agregar Nuevo Administrador</h3>
  <br><br>
  ...
  <input name="strNombre" type="text" class="form-control" id="strNombre" placeholder="Ingrese el Nombre" />
  ...
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-envelope"></i></span><span id="sprytextfield2">
  <input name="strEmail" type="text" class="form-control" id="strEmail" placeholder="Ingresa su Email" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  </div>
  ...
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-ticket"></i></span>
  <input type="text" disabled="disabled" class="form-control" value="12345" readonly />
  </div>
  </div>
  </div>
  ...
  <input type="hidden" name="strPass" value="12345">
