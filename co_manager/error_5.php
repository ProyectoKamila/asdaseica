...
<div class="title-env">
<h1 class="title">Tu contrase&ntilde;a se a cambiada</h1>
...
<div class="panel panel-default">
  <div class="panel-heading">Ya puedes ingresar con tus datos</div>
  <div class="panel-body">
    
  <a class="btn btn-white btn-icon btn-icon-standalone btn-icon-standalone-right" href="index.php">
  <i class="fa-rotate-left"></i><span>Accesar</span></a> 
</div>
</div>
