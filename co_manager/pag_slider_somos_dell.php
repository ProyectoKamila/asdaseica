...
$query_slider = sprintf("SELECT * FROM tblslider_somos WHERE tblslider_somos.idSlider = %s", GetSQLValueString($var_slider, "int"));
...
Eliminando Imagenes y Registro
</div>
<div class="panel-body">

<?php 

$archivo1 = $row_slider['txtImagen'];
$direccion = ("../imagenes/slider_prin/");
unlink ($direccion.$archivo1);

$deleteSQL = sprintf("DELETE FROM tblslider_somos WHERE idSlider=%s",
...
?>
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=pag_slider_somos.php">
