...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbloferta_company (strTitulo, txtImagen_Peq, intArea, intTipo_Ofer, intModalidad, strDuracion, strHorario, strFec_Inicio, txtDirigido_A, txtObj_Gene, txtObj_Espc_Cont, intFacilitador, intFacilitador2, intFacilitador3, txtInf_Adici, strCosto, txtBeneficios, txtIncluye, txtImagen_01, txtVideo_01, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['strFec_Inicio'], "text"),
  ...
  $insertGoTo = "ofer_acade_compa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_verifi = "SELECT * FROM tbloferta_company ORDER BY tbloferta_company.idCompanias DESC";
...
<div class="row">
  ...
  <a href="ofer_acade_compa.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
  ...
  <div class="col-sm-3"><a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_Peq', 'oferta_company', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="form-group-separator"></div>
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strFec_Inicio">Fecha de Inicio</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-download"></i></span>
  <input name="strFec_Inicio" type="text" class="form-control" id="strFec_Inicio" />
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtDirigido_A">Dirigido A</label>
  <div class="col-sm-10">
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtObj_Gene">Objetivo General</label>
  <div class="col-sm-10">
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtObj_Espc_Cont">Objetivos especificos y Contenido</label>
  <div class="col-sm-10">
...
?>
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtInf_Adici">Informa&oacute;n Adicional</label>
  <div class="col-sm-10">
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtBeneficios">Beneficios del Evento</label>
  <div class="col-sm-10">
  <textarea name="txtBeneficios" cols="5" class="form-control" id="txtBeneficios"></textarea>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label" for="txtIncluye">Que Incluye el Evento</label>
  <div class="col-sm-10">
  ...
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_01', 'oferta_company', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="intEstado">Estado del Administrador</label>
  <div class="col-sm-6">
  <div class="input-group">
