...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblslider_inicio (strTitulo, intEstilo, txtImagen, txtTexto_01, txtTexto_02, txtTexto_03, txtTexto_04, txtTexto_05, txtTexto_06, txtTexto_07, txtTexto_08, txtTexto_09, txtTexto_10, txtVideo, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_conexion, $conexion);
$query_slider = "SELECT * FROM tblslider_inicio ORDER BY tblslider_inicio.idSlider DESC";
...
<a href="pag_inicio.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="form-group">
<label class="col-sm-2 control-label" for="intEstilo">Estilo</label>

<div class="col-sm-4">
<select name="intEstilo" class="form-control">
<option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>Estilo 1</option>
<option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>Estilo 2</option>
<option value="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>Video</option>
</select>
</div>
</div>
...
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'slider_prin', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_01">Parrafo 1</label>
<div class="col-sm-10">
<input name="txtTexto_01" type="text" class="form-control" id="txtTexto_01" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_02">Parrafo 2</label>
<div class="col-sm-10">
<input name="txtTexto_02" type="text" class="form-control" id="txtTexto_02" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_03">Parrafo 3</label>
<div class="col-sm-10">
<input name="txtTexto_03" type="text" class="form-control" id="txtTexto_03" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_04">Parrafo 4</label>
<div class="col-sm-10">
<input name="txtTexto_04" type="text" class="form-control" id="txtTexto_04" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_05">Parrafo 5</label>
<div class="col-sm-10">
<input name="txtTexto_05" type="text" class="form-control" id="txtTexto_05" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_06">Parrafo 6</label>
<div class="col-sm-10">
<input name="txtTexto_06" type="text" class="form-control" id="txtTexto_06" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_07">Parrafo 7</label>
<div class="col-sm-10">
<input name="txtTexto_07" type="text" class="form-control" id="txtTexto_07" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_08">Parrafo 8</label>
<div class="col-sm-10">
<input name="txtTexto_08" type="text" class="form-control" id="txtTexto_08" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_09">Parrafo 9</label>
<div class="col-sm-10">
<input name="txtTexto_09" type="text" class="form-control" id="txtTexto_09" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto_10">Parrafo 10</label>
<div class="col-sm-10">
<input name="txtTexto_10" type="text" class="form-control" id="txtTexto_10" placeholder="Ingrese un Parrafo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtVideo">URL de video</label>
<div class="col-sm-10">
<input name="txtVideo" type="text" class="form-control" id="txtVideo" placeholder="Ingrese un enlace para el video">
</div>
</div>
