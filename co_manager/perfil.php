...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbladminis SET strNombre=%s, strEmail=%s WHERE idAdmin=%s",
...
if (isset($_SESSION['MM_idAdmin'])) {
  $sec_tbladminis = $_SESSION['MM_idAdmin'];
}
mysql_select_db($database_conexion, $conexion);
$query_tbladminis = sprintf("SELECT * FROM tbladminis WHERE tbladminis.idAdmin = %s", GetSQLValueString($sec_tbladminis, "int"));
$tbladminis = mysql_query($query_tbladminis, $conexion) or die(mysql_error());
$row_tbladminis = mysql_fetch_assoc($tbladminis);
$totalRows_tbladminis = mysql_num_rows($tbladminis);
?>
<!doctype html>
...
<p class="description">Editando tu Perfil</p>
</div>
<!-- InstanceEndEditable -->
...
<div class="row">
  ...
  <div class="panel-heading"><h3 class="panel-title">Perfil de Usuario</h3></div>
  <div class="panel-body">
    
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" class="form-horizontal">
    
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strNombre">Nombre Administrador</label>
  ...
  <input name="strNombre" type="text" class="form-control" id="strNombre" placeholder="Ingresa Tu Nombre" value="<?php echo htmlentities($row_tbladminis['strNombre'], ENT_COMPAT, 'utf-8'); ?>" />
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strNombre">Email Administrador</label>
    
  <div class="col-sm-9">
    
  <div class="input-group">
  <span class="input-group-addon"><i class="linecons-mail"></i>
  </span><span id="sprytextfield2">
  <input name="strEmail" type="text" class="form-control" id="strEmail" placeholder="Ingresa Tu Email" value="<?php echo htmlentities($row_tbladminis['strEmail'], ENT_COMPAT, 'utf-8'); ?>" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strNombre">Imagen Administrador</label>
    
  <div class="col-sm-6">
    
  <div class="input-group">
  <span class="input-group-addon"><i class="fa"><img src="../imagenes/admins/<?php echo $row_tbladminis['txtImagen']; ?>" alt="Imagen <?php echo $row_tbladminis['strNombre']; ?>" width="38" class="img-circle img-inline userpic-32" /></i>
  </span><span id="sprytextfield3">
  <input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo htmlentities($row_tbladminis['txtImagen'], ENT_COMPAT, 'utf-8'); ?>" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span>
  </div>
    
  </div>
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'admins', '<?php echo $row_tbladminis['idAdmin']; ?>', '<?php echo $row_tbladminis['txtImagen']; ?>')"><span>Cambiar</span></a>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="tagsinput-1">Pregunta secreta</label>
    
  <div class="col-sm-9">
  <a href="perfil1.php" class="btn btn-white">Cambiar Pregunta</a><?php if ($a == 2){ echo " - Pregunta Cambiada"; } ?>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="tagsinput-2">Respuesta secreta</label>
    
  <div class="col-sm-9">
  <a href="perfil2.php" class="btn btn-white">Cambiar Respuesta</a><?php if ($a == 3){ echo " - Respuesta Cambiada"; } ?>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="tagsinput-3">Contraseña</label>
    
  <div class="col-sm-9">
  <a href="perfil3.php" class="btn btn-white">Cambiar Contraseña</a><?php if ($a == 4){ echo " - Contraseña Cambiada"; } ?>
  </div>
  </div>
  ...
  <div class="form-group">
  <button type="submit" class="btn btn-success">Actualizar Tu Perfil</button>
  </div>
    
    <input type="hidden" name="MM_update" value="form1" />
    <input type="hidden" name="idAdmin" value="<?php echo $row_tbladminis['idAdmin']; ?>" />
