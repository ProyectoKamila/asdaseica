...
$var_categoria = "0";
if (isset($_GET['id'])) {
  $var_categoria = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_categoria = sprintf("SELECT * FROM tblgaleria_categoria WHERE tblgaleria_categoria.idCategoria = %s", GetSQLValueString($var_categoria, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblgaleria_categoria SET strTitulo=%s WHERE idCategoria=%s",
  ...
  $updateGoTo = "pag_galeria_cate.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3 class="panel-title">Editando la categoria</h3>
</div>
<div class="panel-body">

<a href="pag_galeria_cate.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="col-sm-10">
<input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo $row_categoria['strTitulo']; ?>">
</div>
</div>
