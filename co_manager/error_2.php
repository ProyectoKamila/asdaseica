...
<div class="row">
  ...
  <form action="error_3.php" method="post" class="form-horizontal">
    
  <div class="form-group">
  <label class="col-sm-3 control-label" for="correo">Ingresa Tu Correo</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="linecons-mail"></i></span><span id="sprytextfield1">
  <input name="correo" type="text" class="form-control" id="correo" placeholder="Ingresa tu Email" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span></div>
