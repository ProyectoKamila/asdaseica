...
<h3 class="panel-title">Lista de Sliders
<br>
<br>
<a href="pag_slider_somos_add.php" class="btn btn-success">Agregar Nuevo Slider</a></h3>
</div>
...
<a href="pag_slider_somos_edit.php?id=<?php echo $row_slider['idSlider']; ?>" class="thumb" data-action="edit">
  <img src="../imagenes/slider_somos/<?php echo $row_slider['txtImagen']; ?>" class="img-responsive" />
</a>

<a href="#" class="name">
  <span>id: <?php echo $row_slider['idSlider']; ?> - <?php echo $row_slider['strTitulo']; ?></span>
  <em>Estilo: <?php echo ObtEsti($row_slider['intEstilo']); ?></em><br>
  <em>Estado: <?php echo ObtEsta($row_slider['intEstado']); ?></em>
</a>

<div class="image-options">
  <a href="pag_slider_somos_edit.php?id=<?php echo $row_slider['idSlider']; ?>"><i class="fa-pencil"></i></a>
  <a href="pag_slider_somos_dell.php?id=<?php echo $row_slider['idSlider']; ?>" onclick="javascript:return asegurar();"><i class="fa-trash"></i></a>
</div>
