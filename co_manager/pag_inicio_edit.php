...
$query_sliders = sprintf("SELECT * FROM tblslider_inicio WHERE tblslider_inicio.idSlider = %s", GetSQLValueString($var_sliders, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblslider_inicio SET strTitulo=%s, txtImagen=%s, intEstilo=%s, txtTexto_01=%s, txtTexto_02=%s, txtTexto_03=%s, txtTexto_04=%s, txtTexto_05=%s, txtTexto_06=%s, txtTexto_07=%s, txtTexto_08=%s, txtTexto_09=%s, txtTexto_10=%s, txtVideo=%s, intEstado=%s WHERE idSlider=%s",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="form-horizontal">
  ...
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'slider_prin', '<?php echo $row_sliders['idSlider']; ?>', '<?php echo $row_sliders['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
