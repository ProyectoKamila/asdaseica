...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbldatos_empresas (strNombre, strRazon_Social, strRif, strTelefono_01, strTelefono_02, strTelefono_03, strEmail_01, strEmail_02, strEmail_03, txtDireccion, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<h3 class="panel-title">Agregando Nueva Empresa</h3>
</div>
...
<div class="col-sm-10">
<input name="strRazon_Social" type="text" class="form-control" id="strRazon_Social" placeholder="Ingrese una Razon Social">
</div>
</div>
...
<div class="col-sm-10">
<input name="strRif" type="text" class="form-control" id="strRif" placeholder="Ingrese un RIF">
</div>
</div>
...
<div class="col-sm-10">
<input name="strTelefono_01" type="text" class="form-control" id="strTelefono_01" placeholder="Ingrese un Telefono">
</div>
</div>
...
<div class="col-sm-10">
<input name="strTelefono_02" type="text" class="form-control" id="strTelefono_02" placeholder="Ingrese un Telefono">
</div>
</div>
...
<div class="col-sm-10">
<input name="strTelefono_03" type="text" class="form-control" id="strTelefono_03" placeholder="Ingrese un Telefono">
</div>
</div>
...
<div class="col-sm-10">
<input name="strEmail_03" type="text" class="form-control" id="strEmail_03" placeholder="Ingrese un Email">
</div>
</div>
...
<div class="col-sm-10">
<textarea name="txtDireccion" cols="5" class="form-control" id="txtDireccion"></textarea>
</div>
</div>
