...
$query_categorias = "SELECT * FROM tblgaleria_categoria ORDER BY tblgaleria_categoria.strTitulo";
$query_limit_categorias = sprintf("%s LIMIT %d, %d", $query_categorias, $startRow_categorias, $maxRows_categorias);
$categorias = mysql_query($query_limit_categorias, $conexion) or die(mysql_error());
...
<h3 class="panel-title">Lista de las Categorias</h3>
<br>
<br>
<a href="pag_galeria_cate_add.php" class="btn btn-success">Agregar Nueva Categoria</a>
</div>
...
<?php do { ?>
  <tr>
    <th><?php echo $row_categorias['idCategoria']; ?></th>
    <td><?php echo $row_categorias['strTitulo']; ?></td>
    <td><a href="pag_galeria_cate_edit.php?id=<?php echo $row_categorias['idCategoria']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="pag_galeria_cate_dell.php?id=<?php echo $row_categorias['idCategoria']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
  </tr>
