...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbladminis SET strNombre=%s, strEmail=%s, intNivel=%s, intEstado=%s WHERE idAdmin=%s",
  ...
  $updateGoTo = "administrador_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<p class="description">Agregando Nuevo Administrador</p>
</div>
<!-- InstanceEndEditable -->
...
function asegurar()
{
	rc = confirm("¿Seguro lo desea Resetear?"); 
	return rc;
}
</script>
...
<div class="row">
  ...
  <br><br>
  <a href="administrador_lista.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm"><i class="fa-reply"></i><span>Regresar</span></a>
  </div>
  ...
  <label class="col-sm-3 control-label" for="strNombre">Nombre del Administrador</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-user"></i></span>
  <input name="strNombre" type="text" class="form-control" id="strNombre" value="<?php echo $row_tbladministradores['strNombre']; ?>" />
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="">Email del Administrador</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-envelope"></i></span>
  <input name="strEmail" type="text" class="form-control" id="strEmail" value="<?php echo $row_tbladministradores['strEmail']; ?>" />
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="">Nivel del Administrador</label>
  <div class="col-sm-6">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-database"></i></span>
  <select name="intNivel" id="intNivel" class="form-control" >
  <option value="1" <?php if (!(strcmp(1, $row_tbladministradores['intNivel']))) {echo "selected=\"selected\"";} ?>>Vendedor</option>
  <option value="2" <?php if (!(strcmp(2, $row_tbladministradores['intNivel']))) {echo "selected=\"selected\"";} ?>>Manager</option>
  <option value="3" <?php if (!(strcmp(3, $row_tbladministradores['intNivel']))) {echo "selected=\"selected\"";} ?>>Administrador</option>
  </select>
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="">Contraseña</label>
  <div class="col-sm-6">
  <div class="input-group">  
  <a href="administrador_lista_reset.php?id=<?php echo $row_tbladministradores['idAdmin']; ?>" class="btn btn-white btn-icon btn-icon-standalone btn-sm" onclick="javascript:return asegurar();" ><i class="fa-history"></i><span>Resetear</span></a>
  <?php if ($_GET['a'] == 1) { echo ' - Reseteado a 12345'; } ?>
  </div>
  </div>
  </div>
  ...
  <option value="1" <?php if (!(strcmp(1, $row_tbladministradores['intEstado']))) {echo "SELECTED";} ?>>Activo</option>
  <option value="0" <?php if (!(strcmp(0, $row_tbladministradores['intEstado']))) {echo "SELECTED";} ?>>Desactivado</option>
  </select>
  </div>
  </div>
  </div>                                
  ...
  <input type="hidden" name="idAdmin" value="<?php echo $row_tbladministradores['idAdmin']; ?>">
