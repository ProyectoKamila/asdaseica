...
<h3 class="panel-title">Finalizar Llamado</h3> 
</div>
...
<p>Nuestra Dirección Académica ha confirmado el depósito correspondiente a su inscripción en nuestro curso de '.$oferta_Seleccionada.'. Anexa al presente, le remitimos la información preliminar necesaria para su ubicación en nuestro escenario educativo.</p>
...
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=cursos_ejecucion_lista.php?li=<?php echo $row_listas2['intCurso']; ?>&cal=<?php echo $row_listas2['intCalendario']; ?>">
