...
$query_ofertas = "SELECT * FROM tbloferta_company ORDER BY tbloferta_company.idCompanias";
...
<div class="title-env">
<h1 class="title">Oferta Academica Compa&ntilde;ias</h1>
...
<br>
<a href="ofer_acade_compa_add.php" class="btn btn-success">Agregar Nueva Oferta</a>
</div>
...
<th data-priority="3">Ver<br> cursos</th>
...
<?php do { ?>
  <tr>
    <td><?php echo $row_ofertas['idCompanias']; ?></td>
    ...
    <td><a href="ofer_acade_compa_curso.php?id=<?php echo $row_ofertas['idCompanias']; ?>" class="btn btn-icon btn-warning2"><i class="fa-edit"></i></a></td>
    <td><?php echo ObtEsta($row_ofertas['intEstado']); ?></td>
    <td><a href="ofer_acade_compa_edit.php?id=<?php echo $row_ofertas['idCompanias']; ?>" class="btn btn-icon btn-warning"><i class="fa-edit"></i></a> <a href="ofer_acade_compa_del.php?id=<?php echo $row_ofertas['idCompanias']; ?>" onclick="javascript:return asegurar();" class="btn btn-icon btn-red"><i class="fa-remove"></i></a></td>
  </tr>
