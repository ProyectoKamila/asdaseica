...
<h3 class="panel-title">Paquetes de datos para: <?php echo ObtNombOferAcade($_GET['id']); ?> </h3><br>
<br>
<a href="ofer_acade_paquetes_add.php?id=<?php echo $_GET['id']; ?>" class="btn btn-success">Agregar Nuevo Paquete</a>
</div>
