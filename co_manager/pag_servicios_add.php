...
$query_servicios = "SELECT * FROM tblservicios ORDER BY tblservicios.idValores DESC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblservicios (strTitulo, txtTexto, txtImagen, intEstado) VALUES (%s, %s, %s, %s)",
...
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'servicios', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
