...
<div class="row">
  ...
  <h3 class="panel-title">Cambiar La Contrase&ntilde;a</h3>
  ...
  <h2><span class="let_roja">Las contrase&ntilde;as No Coinciden</span></h2>
  ...
  <label class="col-sm-3 control-label" for="strNombre">Nueva Contrase&ntilde;a</label>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strNombre">Repetir la Contrase&ntilde;a</label>
