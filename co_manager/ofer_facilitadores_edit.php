...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblfacilitadores SET strNombre=%s, txtInformacion=%s, intEstado=%s WHERE idFacilitador=%s",
                       GetSQLValueString($_POST['strNombre'], "text"),
                       GetSQLValueString($_POST['txtInformacion'], "text"),
                       GetSQLValueString($_POST['intEstado'], "int"),
                       GetSQLValueString($_POST['idFacilitador'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "ofer_facilitadores_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$var_facilitador = "0";
if (isset($_GET['id'])) {
  $var_facilitador = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_facilitador = sprintf("SELECT * FROM tblfacilitadores WHERE tblfacilitadores.idFacilitador = %s", GetSQLValueString($var_facilitador, "int"));
$facilitador = mysql_query($query_facilitador, $conexion) or die(mysql_error());
$row_facilitador = mysql_fetch_assoc($facilitador);
$totalRows_facilitador = mysql_num_rows($facilitador);
?>
<!doctype html>
...
<h3 class="panel-title">Editando Facilitador</h3>
</div>
<div class="panel-body">

<a href="ofer_facilitadores_lista.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<label class="col-sm-2 control-label" for="strNombre">Titulo</label>
<div class="col-sm-10">
<input name="strNombre" type="text" class="form-control" id="strNombre" value="<?php echo $row_facilitador['strNombre']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtInformacion">Informaci&oacute;n General</label>
<div class="col-sm-10">
<textarea name="txtInformacion" cols="5" class="form-control" id="txtInformacion"><?php echo $row_facilitador['txtInformacion']; ?></textarea>
</div>
</div>
...
<option value="1" <?php if (!(strcmp(1, htmlentities($row_facilitador['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Activo</option>
<option value="0" <?php if (!(strcmp(0, htmlentities($row_facilitador['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Desactivado</option>
</select>
</div>
</div>                      
...
<button type="submit" class="btn btn-success">Actualizar</button>
  ...
  <input type="hidden" name="idFacilitador" value="<?php echo $row_facilitador['idFacilitador']; ?>">
</form>
