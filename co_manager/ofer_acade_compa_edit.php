...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbloferta_company SET strTitulo=%s, txtImagen_Peq=%s, strDuracion=%s, strHorario=%s, strFec_Inicio=%s, txtDirigido_A=%s, txtObj_Gene=%s, strCosto=%s, intFacilitador=%s, intFacilitador2=%s, intFacilitador3=%s, txtInf_Adici=%s, txtBeneficios=%s, txtIncluye=%s, intArea=%s, intTipo_Ofer=%s, intModalidad=%s, txtImagen_01=%s, txtVideo_01=%s, intEstado=%s WHERE idCompanias=%s",
                       ...
                       GetSQLValueString($_POST['idCompanias'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "ofer_acade_compa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_verifi = sprintf("SELECT * FROM tbloferta_company WHERE tbloferta_company.idCompanias = %s", GetSQLValueString($var_verifi, "int"));
...
<div class="row">
  ...
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_Peq', 'oferta_company', '<?php echo $row_verifi['idCompanias']; ?>', '<?php echo $row_verifi['txtImagen_Peq']; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strDuracion">Duraci&oacute;n del Evento</label>
  <div class="col-sm-6">
  <div class="input-group">
  ...
  <input name="strFec_Inicio" type="text" class="form-control" id="strFec_Inicio" value="<?php echo $row_verifi['strFec_Inicio'] ?>" />
  </div>
  </div>
  </div>
  ...
  <div class="col-sm-10">
  <textarea name="txtBeneficios" cols="5" class="form-control" id="txtBeneficios"><?php echo $row_verifi['txtBeneficios']; ?></textarea>
  </div>
  </div>
  ...
  <div class="col-sm-3">
  <a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen_01', 'oferta_company', '<?php echo $row_verifi['idCompanias']; ?>', '<?php echo $row_verifi['txtImagen_01']; ?>')"><span>Buscar La Imagen</span></a>
  </div>
  </div>
  ...
  <input name="txtVideo_01" type="text" class="form-control" id="txtVideo_01" value="<?php echo $row_verifi['txtVideo_03']; ?>"/>
  </div>
  </div>
  </div>
  ...
  <button type="submit" class="btn btn-success">Actualizar</button>
    ...
    <input type="hidden" name="idCompanias" value="<?php echo $row_verifi['idCompanias']; ?>">
  </form>
