...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	if ($_POST['strResp_Secre'] == $_POST['strResp_Secre2'] ) {
				
  $updateSQL = sprintf("UPDATE tbladminis SET strResp_Secre=%s WHERE idAdmin=%s",
                       GetSQLValueString(md5($_POST['strResp_Secre']), "text"),
                       GetSQLValueString($_POST['idAdmin'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "perfil6.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row">
  ...
  <h3 class="panel-title"><strong>Formulario 2/4</strong></h3>
...
<h2><span class="let_roja">Las respuestas No Coinciden</span>, Por favor intenta nuevamente.</h2><br>
<br>
...
<?php } ?>  
  ...
  <label class="col-sm-3 control-label" for="strResp_Secre">Crear Respuesta Secreta</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-pencil"></i></span><span id="sprytextfield1">
  <input name="strResp_Secre" type="password" class="form-control" id="strResp_Secre" />
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strResp_Secre2">Repetir Respuesta Secreta</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-pencil"></i></span><span id="sprytextfield2">
  <input name="strResp_Secre2"  type="password" class="form-control" id="strResp_Secre2" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  </div>
