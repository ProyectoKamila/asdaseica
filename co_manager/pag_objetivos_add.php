...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblobjetivos_titu (strTutulo, txtPar_Cor, txtImagen, intEstado) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "pag_objetivos_add_2.php?obj=".$idg;
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_objetivo = "SELECT * FROM tblobjetivos_titu ORDER BY tblobjetivos_titu.idObjetivo DESC";
$objetivo = mysql_query($query_objetivo, $conexion) or die(mysql_error());
$row_objetivo = mysql_fetch_assoc($objetivo);
$totalRows_objetivo = mysql_num_rows($objetivo);
...
<div class="col-sm-10">
<input name="strTutulo" type="text" class="form-control" id="strTutulo" placeholder="Ingrese un Titulo">
</div>
</div>
...
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'objetivos', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
...
<div class="col-sm-10">
<textarea name="txtPar_Cor" cols="5" class="form-control" id="txtPar_Cor"></textarea>
</div>
</div>
