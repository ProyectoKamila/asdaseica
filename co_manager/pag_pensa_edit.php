...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblpensamiento SET strTitulo=%s, txtParrafo=%s WHERE idPensamiento=%s",
                       GetSQLValueString($_POST['strTitulo'], "text"),
                       GetSQLValueString($_POST['txtParrafo'], "text"),
                       GetSQLValueString($_POST['idPensamiento'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "pag_pensa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$var_pensamiento = "0";
if (isset($_GET['id'])) {
  $var_pensamiento = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_pensamiento = sprintf("SELECT * FROM tblpensamiento WHERE tblpensamiento.idPensamiento = %s", GetSQLValueString($var_pensamiento, "int"));
$pensamiento = mysql_query($query_pensamiento, $conexion) or die(mysql_error());
$row_pensamiento = mysql_fetch_assoc($pensamiento);
$totalRows_pensamiento = mysql_num_rows($pensamiento);
?>
<!doctype html>
...
<div class="title-env">
<h1 class="title">Pensamiento del Dia</h1>
<p class="description">Ubicado en el Footer</p>
</div>
<!-- InstanceEndEditable -->
...
<h3 class="panel-title">Editando <?php echo $row_pensamiento['strTitulo']; ?></h3>
</div>
<div class="panel-body">

<a href="pag_pensa.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="col-sm-10">
<input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo htmlentities($row_pensamiento['strTitulo'], ENT_COMPAT, 'utf-8'); ?>" >
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtParrafo">Texto Del Elemento</label>
<div class="col-sm-10">
<textarea name="txtParrafo" cols="5" class="form-control" id="txtParrafo"><?php echo htmlentities($row_pensamiento['txtParrafo'], ENT_COMPAT, 'utf-8'); ?></textarea>
</div>
</div>
...
<input type="hidden" name="idPensamiento" value="<?php echo $row_pensamiento['idPensamiento']; ?>">
