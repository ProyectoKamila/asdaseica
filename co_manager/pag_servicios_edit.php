...
$var_servicios = "0";
if (isset($_GET['id'])) {
  $var_servicios = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_servicios = sprintf("SELECT * FROM tblservicios WHERE tblservicios.idValores = %s", GetSQLValueString($var_servicios, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblservicios SET strTitulo=%s, txtTexto=%s, txtImagen=%s, intEstado=%s WHERE idValores=%s",
...
<h3 class="panel-title">Editando: <?php echo $row_servicios['strTitulo']; ?></div>
<div class="panel-body">

<a href="pag_servicios.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="col-sm-10">
<input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo htmlentities($row_servicios['strTitulo'], ENT_COMPAT, 'utf-8'); ?>" >
</div>
</div>
...
<div class="col-sm-10">
<textarea name="txtTexto" cols="5" class="form-control" id="txtTexto"><?php echo htmlentities($row_servicios['txtTexto'], ENT_COMPAT, 'utf-8'); ?></textarea>
</div>
</div>
...
<label class="col-sm-2 control-label" for="txtImagen">Imagen Descriptiva</label>
<div class="col-sm-6">
<input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo htmlentities($row_servicios['txtImagen']); ?>" >
</div>
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'servicios', '<?php echo $row_servicios['idValores']; ?>', '<?php echo $row_servicios['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
...
<option value="1" <?php if (!(strcmp(1, htmlentities($row_servicios['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Activo</option>
<option value="0" <?php if (!(strcmp(0, htmlentities($row_servicios['intEstado'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Desactivado</option>
</select>
</div>
</div>
...
<button type="submit" class="btn btn-success">Actualizar</button>
  ...
  <input type="hidden" name="idValores" value="<?php echo $row_servicios['idValores']; ?>">
</form>
