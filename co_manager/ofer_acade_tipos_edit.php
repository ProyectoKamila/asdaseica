...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE tbloferta_tipo SET strTipo=%s WHERE idTipo=%s",
  ...
  $updateGoTo = "ofer_acade_tipos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_tipo = sprintf("SELECT * FROM tbloferta_tipo WHERE tbloferta_tipo.idTipo = %s", GetSQLValueString($var_tipo, "int"));
...
<label class="col-sm-2 control-label" for="strTipo">Actualizar los Tipo de Evento</label>
<div class="col-sm-6">
<input name="strTipo" type="text" class="form-control" id="strTipo" value="<?php echo htmlentities($row_tipo['strTipo'], ENT_COMPAT, 'utf-8'); ?>" >
</div>
</div>
...
<button type="submit" class="btn btn-success">Actualizar</button>
  ...
  <input type="hidden" name="idTipo" value="<?php echo $row_tipo['idTipo']; ?>">
</form>
