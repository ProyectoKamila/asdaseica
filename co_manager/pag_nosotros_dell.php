...
<div class="panel-heading">Eliminando Imagenes y Registro de <strong><?php echo $row_somos['strTitulo']; ?></strong></div>
<div class="panel-body">

<?php 

$archivo1 = $row_somos['txtImagen'];
$archivo2 = $row_somos['texImagen_01'];
$archivo3 = $row_somos['texImagen_02'];
$archivo4 = $row_somos['texImagen_03'];
$archivo5 = $row_somos['texImagen_04'];
$archivo6 = $row_somos['texImagen_05'];
$archivo7 = $row_somos['texImagen_06'];
$direccion = ("../imagenes/somos/");
unlink ($direccion.$archivo1);
unlink ($direccion.$archivo2);
unlink ($direccion.$archivo3);
unlink ($direccion.$archivo4);
unlink ($direccion.$archivo5);
unlink ($direccion.$archivo6);
unlink ($direccion.$archivo7);

$deleteSQL = sprintf("DELETE FROM tblsomo_aseica WHERE idSomos=%s",
...
?>
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=pag_nosotros.php">
