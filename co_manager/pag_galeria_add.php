...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblgaleria (strTitulo, intCategoria, strParrafo_Corto, txtImagen, intEstado) VALUES (%s, %s, %s, %s, %s)",
...
mysql_select_db($database_conexion, $conexion);
$query_imagen = "SELECT * FROM tblgaleria ORDER BY tblgaleria.idGaleria DESC ";
...
mysql_select_db($database_conexion, $conexion);
$query_categoria = "SELECT * FROM tblgaleria_categoria ORDER BY tblgaleria_categoria.strTitulo";
...
<h3 class="panel-title">Agregando Imagen</h3>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="intCategoria">Categoria</label>

<div class="col-sm-10">
<select name="intCategoria" class="form-control">
<?php do { ?>
<option value="<?php echo $row_categoria['idCategoria']?>" ><?php echo $row_categoria['strTitulo']?></option>
...
<div class="col-sm-10">
<textarea name="strParrafo_Corto" cols="5" class="form-control" id="strParrafo_Corto"></textarea>
</div>
</div>
...
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'galeria', '<?php echo $id; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
