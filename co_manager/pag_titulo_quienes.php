...
$query_quienes_titulos = "SELECT * FROM tbltitulo_quienes";
$quienes_titulos = mysql_query($query_quienes_titulos, $conexion) or die(mysql_error());
$row_quienes_titulos = mysql_fetch_assoc($quienes_titulos);
$totalRows_quienes_titulos = mysql_num_rows($quienes_titulos);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbltitulo_quienes SET strTitulo=%s, strSub_titulo=%s, txtTexto=%s WHERE idTitulo=%s",
                       GetSQLValueString($_POST['strTitulo'], "text"),
                       GetSQLValueString($_POST['strSub_titulo'], "text"),
                       GetSQLValueString($_POST['txtTexto'], "text"),
                       GetSQLValueString($_POST['idTitulo'], "int"));
...
<div class="title-env">
<h1 class="title">Pag Quienes Somos</h1>
<p class="description">Elementos dentro de esa pagina</p>
</div>
<!-- InstanceEndEditable -->
...
<h3 class="panel-title">Titulo de Quienes Somos</h3>
</div>
...
<div class="col-sm-10">
<input name="strTitulo" value="<?php echo htmlentities($row_quienes_titulos['strTitulo'], ENT_COMPAT, 'utf-8'); ?>" type="text" class="form-control" id="strTitulo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strSub_titulo">Sub - Titulo</label>

<div class="col-sm-10">
<input name="strSub_titulo" value="<?php echo htmlentities($row_quienes_titulos['strSub_titulo'], ENT_COMPAT, 'utf-8'); ?>" type="text" class="form-control" id="strSub_titulo">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="txtTexto">Texto</label>

<div class="col-sm-10">
<textarea name="txtTexto" class="form-control" cols="5" id="txtTexto"><?php echo $row_quienes_titulos['txtTexto']; ?></textarea>
</div>
</div>
...
<input type="hidden" name="idTitulo" value="<?php echo $row_quienes_titulos['idTitulo']; ?>">
</form>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($quienes_titulos);
?>
