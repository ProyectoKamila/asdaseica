...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblgaleria SET strTitulo=%s, intCategoria=%s, strParrafo_Corto=%s, txtImagen=%s, intEstado=%s WHERE idGaleria=%s",
                       GetSQLValueString($_POST['strTitulo'], "text"),
                       GetSQLValueString($_POST['intCategoria'], "int"),
                       GetSQLValueString($_POST['strParrafo_Corto'], "text"),
...
mysql_select_db($database_conexion, $conexion);
$query_imagen = sprintf("SELECT * FROM tblgaleria WHERE tblgaleria.idGaleria = %s", GetSQLValueString($var_imagen, "int"));
$imagen = mysql_query($query_imagen, $conexion) or die(mysql_error());
$row_imagen = mysql_fetch_assoc($imagen);
$totalRows_imagen = mysql_num_rows($imagen);

mysql_select_db($database_conexion, $conexion);
$query_categoria = "SELECT * FROM tblgaleria_categoria";
...
<h3 class="panel-title">Editando La Imagen</h3>
</div>
<div class="panel-body">

<a href="pag_galeria.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="col-sm-10">
<input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo $row_imagen['strTitulo']; ?>" >
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="idCategoria">Categoria</label>

<div class="col-sm-10">
<select name="idCategoria" class="form-control">
<?php do { ?>
<option value="<?php echo $row_categoria['idCategoria']?>" <?php if (!(strcmp($row_categoria['idCategoria'], $row_imagen['intCategoria']))) {echo "SELECTED";} ?>><?php echo $row_categoria['strTitulo']?></option>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strParrafo_Corto">Parrafo Corto</label>
<div class="col-sm-10">
<textarea name="strParrafo_Corto" cols="5" class="form-control" id="strParrafo_Corto"><?php echo $row_imagen['strParrafo_Corto']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo $row_imagen['txtImagen']; ?>">
</div>
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'galeria', '<?php echo $row_imagen['idGaleria']; ?>', '<?php echo $row_imagen['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
...
<select name="intEstado" class="form-control">
        <option value="1" <?php if (!(strcmp(1, $row_imagen['intEstado']))) {echo "SELECTED";} ?>>Activo</option>
        <option value="0" <?php if (!(strcmp(0, $row_imagen['intEstado']))) {echo "SELECTED";} ?>>Desactivado</option>
</select>
</div>
</div>
...
<input type="hidden" name="idGaleria" value="<?php echo $row_imagen['idGaleria']; ?>">
