...
$query_cursos = "SELECT * FROM tblcursos_aseica WHERE tblcursos_aseica.intEstado = 12 ORDER BY tblcursos_aseica.intCalen";
...
<h3 class="panel-title">Lista de Cursos Realizados en Aseica</h3>
</div>
