...
$var_participantes = "0";
if (isset($_GET['id'])) {
  $var_participantes = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_participantes = sprintf("SELECT * FROM tbldatos_participantes WHERE tbldatos_participantes.intEmpresa = %s", GetSQLValueString($var_participantes, "int"));
$participantes = mysql_query($query_participantes, $conexion) or die(mysql_error());
$row_participantes = mysql_fetch_assoc($participantes);
$totalRows_participantes = mysql_num_rows($participantes);


if ($row_participantes['idParticipantes'] == '') {

if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbldatos_empresas WHERE idEmpresa=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($deleteSQL, $conexion) or die(mysql_error());

  $deleteGoTo = "datos_empresas.php";
...
<h3 class="panel-title">No se puede eliminar la empresa</h3>
</div>
<div class="panel-body">

<?php if ($row_participantes['idParticipantes'] != '') { ?>
...
<div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
    ...
    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
        ...
        <tbody>
          <?php do { ?>
  <tr>
    <td><?php echo $row_participantes['strNombre']; ?></td>
