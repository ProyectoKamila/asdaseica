...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbldatos_empresas SET strNombre=%s, strRazon_Social=%s, strRif=%s, strTelefono_01=%s, strTelefono_02=%s, strTelefono_03=%s, strEmail_01=%s, strEmail_02=%s, strEmail_03=%s, txtDireccion=%s, intEstado=%s WHERE idEmpresa=%s",
                       GetSQLValueString($_POST['strNombre'], "text"),
                       GetSQLValueString($_POST['strRazon_Social'], "text"),
                       GetSQLValueString($_POST['strRif'], "text"),
                       GetSQLValueString($_POST['strTelefono_01'], "text"),
                       GetSQLValueString($_POST['strTelefono_02'], "text"),
                       GetSQLValueString($_POST['strTelefono_03'], "text"),
                       GetSQLValueString($_POST['strEmail_01'], "text"),
                       GetSQLValueString($_POST['strEmail_02'], "text"),
                       GetSQLValueString($_POST['strEmail_03'], "text"),
...
$var_empresas = "0";
if (isset($_GET['id'])) {
  $var_empresas = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_empresas = sprintf("SELECT * FROM tbldatos_empresas WHERE tbldatos_empresas.idEmpresa = %s", GetSQLValueString($var_empresas, "int"));
...
<h3 class="panel-title">Ediatndo Empresa</h3>
</div>
<div class="panel-body">

<a href="datos_empresas.php" class="btn btn-white btn-icon btn-icon-standalone btn-sm">
...
<div class="col-sm-10">
<input type="text" name="strNombre" class="form-control" value="<?php echo $row_empresas['strNombre']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strRazon_Social">Razon Social</label>
<div class="col-sm-10">
<input type="text" name="strRazon_Social" class="form-control" value="<?php echo $row_empresas['strRazon_Social']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strRif">Rif</label>
<div class="col-sm-6">
<input type="text" name="strRif" class="form-control" value="<?php echo $row_empresas['strRif']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strTelefono_01">Telefono 01</label>
<div class="col-sm-6">
<input type="text" name="strTelefono_01" class="form-control" value="<?php echo $row_empresas['strTelefono_01']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strTelefono_02">Telefono 02</label>
<div class="col-sm-6">
<input type="text" name="strTelefono_02" class="form-control" value="<?php echo $row_empresas['strTelefono_02']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strTelefono_03">Telefono 03</label>
<div class="col-sm-6">
<input type="text" name="strTelefono_03" class="form-control" value="<?php echo $row_empresas['strTelefono_03']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strEmail_01">Email 01</label>
<div class="col-sm-6">
<input type="text" name="strEmail_01" class="form-control" value="<?php echo $row_empresas['strEmail_01']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strEmail_02">Email 02</label>
<div class="col-sm-6">
<input type="text" name="strEmail_02" class="form-control" value="<?php echo $row_empresas['strEmail_02']; ?>">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="strEmail_03">Email 03</label>
<div class="col-sm-6">
<input type="text" name="strEmail_03" class="form-control" value="<?php echo $row_empresas['strEmail_03']; ?>">
</div>
</div>
...
<div class="col-sm-10">
<textarea name="txtDireccion" class="form-control" id="txtDireccion"><?php echo $row_empresas['txtDireccion']; ?></textarea>
</div>
</div>
...
<option value="1" <?php if (!(strcmp(1, $row_empresas['intEstado']))) {echo "SELECTED";} ?>>Activo</option>
<option value="0" <?php if (!(strcmp(0, $row_empresas['intEstado']))) {echo "SELECTED";} ?>>Desactivado</option>
</select>
</div>
</div>
...
<button type="submit" class="btn btn-success">Agregar</button>
  ...
  <input type="hidden" name="idEmpresa" value="<?php echo $row_empresas['idEmpresa']; ?>">
</form>
<p>&nbsp;</p>
</div>
</div>
