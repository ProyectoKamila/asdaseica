...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblsomo_aseica SET strTitulo=%s, txtTexto=%s, txtImagen=%s, texImagen_01=%s, texImagen_02=%s, texImagen_03=%s, texImagen_04=%s, texImagen_05=%s, texImagen_06=%s, texTexto_01=%s, texTexto_02=%s, texTexto_03=%s, texTexto_04=%s, texTexto_05=%s, txtVideo_01=%s, txtVideo_02=%s, txtVideo_03=%s, txtVideo_04=%s, intEstado=%s WHERE idSomos=%s",
                       ...
                       GetSQLValueString($_POST['idSomos'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "pag_nosotros.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_somos = sprintf("SELECT * FROM tblsomo_aseica WHERE tblsomo_aseica.idSomos = %s", GetSQLValueString($var_somos, "int"));
...
<div class="panel-heading">Editando: <strong><?php echo $row_somos['strTitulo']; ?></strong></div>
...
<div class="col-sm-10">
<input name="strTitulo" type="text" class="form-control" id="strTitulo" value="<?php echo $row_somos['strTitulo']; ?>" >
</div>
</div>
...
<div class="col-sm-10">
<textarea name="txtTexto" cols="5" class="form-control" id="txtTexto"><?php echo $row_somos['txtTexto']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<img src="../imagenes/somos/<?php echo $row_somos['txtImagen']; ?>" class="img-responsive" >
</div>
</div>
...
<label class="col-sm-2 control-label" for="txtImagen">Imagen Descriptiva</label>
<div class="col-sm-6">
<input name="txtImagen" type="text" class="form-control" id="txtImagen" value="<?php echo $row_somos['txtImagen']; ?>" >
</div>
<div class="col-sm-3">
<a class="btn btn-white btn-single" href="javascript:subirimagen('txtImagen', 'somos', '<?php echo $row_somos['idSomos']; ?>', '<?php echo $row_somos['txtImagen']; ?>')"><span>Buscar La Imagen</span></a>
</div>
</div>
...
<div class="col-sm-6">
<input name="texImagen_01" type="text" class="form-control" id="texImagen_01" value="<?php echo $row_somos['texImagen_01']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-9">
<textarea name="texTexto_01" cols="5" class="form-control" id="texTexto_01"><?php echo $row_somos['texTexto_01']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<input name="texImagen_02" type="text" class="form-control" id="texImagen_02" value="<?php echo $row_somos['texImagen_02']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-9">
<textarea name="texTexto_02" cols="5" class="form-control" id="texTexto_02"><?php echo $row_somos['texTexto_02']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<input name="texImagen_03" type="text" class="form-control" id="texImagen_03" value="<?php echo $row_somos['texImagen_03']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-9">
<textarea name="texTexto_03" cols="5" class="form-control" id="texTexto_03"><?php echo $row_somos['texTexto_03']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<input name="texImagen_04" type="text" class="form-control" id="texImagen_04" value="<?php echo $row_somos['texImagen_04']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-9">
<textarea name="texTexto_04" cols="5" class="form-control" id="texTexto_04"><?php echo $row_somos['texTexto_04']; ?></textarea>
</div>
</div>
...
<div class="col-sm-6">
<input name="texImagen_05" type="text" class="form-control" id="texImagen_05" value="<?php echo $row_somos['texImagen_05']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-6">
<input name="texImagen_06" type="text" class="form-control" id="texImagen_06" value="<?php echo $row_somos['texImagen_06']; ?>">
</div>
<div class="col-sm-3">
...
<div class="col-sm-9">
<input name="txtVideo_01" type="text" class="form-control" id="txtVideo_01" placeholder="Ingresa Una URL" value="<?php echo $row_somos['txtVideo_01']; ?>">
</div>
</div>
...
<div class="col-sm-9">
<input name="txtVideo_02" type="text" class="form-control" id="txtVideo_02" placeholder="Ingresa Una URL" value="<?php echo $row_somos['txtVideo_02']; ?>">
</div>
</div>
...
<div class="col-sm-9">
<input name="txtVideo_03" type="text" class="form-control" id="txtVideo_03" placeholder="Ingresa Una URL" value="<?php echo $row_somos['txtVideo_03']; ?>">
</div>
</div>
...
<div class="col-sm-9">
<input name="txtVideo_04" type="text" class="form-control" id="txtVideo_04" placeholder="Ingresa Una URL" value="<?php echo $row_somos['txtVideo_04']; ?>">
</div>
</div>
...
<option value="1" <?php if (!(strcmp(1, $row_somos['intEstado']))) {echo "SELECTED";} ?>>Activo</option>
<option value="0" <?php if (!(strcmp(0, $row_somos['intEstado']))) {echo "SELECTED";} ?>>Desactivado</option>
</select>
</div>
</div>
...
<input type="hidden" name="idSomos" value="<?php echo $row_somos['idSomos']; ?>">
