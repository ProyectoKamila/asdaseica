...
<div class="row">
  ...
  <h3 class="panel-title">Cambiar La Pregunta: <?php echo $row_usuario['strPreg_Secre']; ?></h3>
  ...
  <li class="previous">
  <a href="perfil.php"><i class="entypo-left-open"></i> Regresar</a>
  </li>
  </ul>
  <?php } else { ?>
  
  <h2><span class="let_roja">Las preguntas No Coinciden</span></h2>
  ...
  <label class="col-sm-3 control-label" for="strNombre">Nueva Pregunta</label>
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strNombre">Repetir La Pregunta</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-user"></i></span><span id="sprytextfield2">
