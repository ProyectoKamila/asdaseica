...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $insertSQL = sprintf("INSERT INTO tbldatos_participantes (strNombre, strApellido, strTelefono, strCedula, strEmail, intCurso_Asistido, intEstado) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString(ObtNombreSolicitante($row_listas2['intPaticiapante']), "text"),
                       GetSQLValueString(ObtApellidoSolicitante($row_listas2['intPaticiapante']), "text"),
                       GetSQLValueString(ObtTelefonoSolicitante($row_listas2['intPaticiapante']), "text"),
                       GetSQLValueString(ObtCedulaSolicitante($row_listas2['intPaticiapante']), "text"),
                       GetSQLValueString(ObtEmailSolicitante($row_listas2['intPaticiapante']), "text"),
                       GetSQLValueString($row_listas2['intCurso'], "int"),
...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="panel-heading">
      <h3 class="panel-title">Aceptando el pago </h3>
    </div>
...
$asunto   = 'INSCRIPCIÓN CONFIRMADA – CURSO DE '.$oferta_Seleccionad.' Hoy '.ObtFecha($resu);
...
<p>Por favor ingrese en este enlace y descargue su <a href="http://www.aseica.com.ve/paquete/'.$row_listas2['intCurso'].'">Paquete de Información Preliminar</a></p>

<p>Nuevamente b'.$sexo2.'. Lo esperamos en nuestras aulas.</p>

<p>Gracias por crecer con nosotros.</p>

<p align="center">Dierección Académica</p>
