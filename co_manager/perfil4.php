...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	if ($_POST['strPreg_Secre'] == $_POST['strPreg_Secre2'] ) {
	
  $updateSQL = sprintf("UPDATE tbladminis SET strPreg_Secre=%s WHERE idAdmin=%s",
                       GetSQLValueString($_POST['strPreg_Secre'], "text"),
                       GetSQLValueString($_POST['idAdmin'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());

  $updateGoTo = "perfil5.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row">
  ...
  <h3 class="panel-title"><strong>Formulario 1/4</strong></h3>
...
<h3>Hola <strong><?php echo $_SESSION['MM_Username']; ?> </strong>como es la primera vez que accedes a la administraci&oacute;n, por favor completa los siguientes formularios:</h3><br>
<br>
...
<h2><span class="let_roja">Las preguntas No Coinciden</span>, Por favor intenta nuevamente.</h2><br>
<br>
...
<?php } ?>  
  ...
  <label class="col-sm-3 control-label" for="strPreg_Secre">Crear Pregunta Secreta</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-tag"></i></span><span id="sprytextfield1">
  <input name="strPreg_Secre" type="text" class="form-control" id="strPreg_Secre" />
  ...
  <div class="form-group">
  <label class="col-sm-3 control-label" for="strPreg_Secre2">Repetir La Pregunta Secreta</label>
    
  <div class="col-sm-9">
  <div class="input-group">
  <span class="input-group-addon"><i class="fa-tag"></i></span><span id="sprytextfield2">
  <input name="strPreg_Secre2"  type="text" class="form-control" id="strPreg_Secre2" />
  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></div>
  </div>
  </div>
