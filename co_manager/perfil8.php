...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateSQL = sprintf("UPDATE tbladminis SET intPrimera=%s WHERE idAdmin=%s",
                       GetSQLValueString(1, "int"),
                       GetSQLValueString($row_usuario['idAdmin'], "int"));
...
<div class="row">
  ...
  <h3 class="panel-title"><strong>Formularios completos</strong></h3>
...
Gracias por relizar todos los formularios.
</h3>
