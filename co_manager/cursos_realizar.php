...
$query_cursos = "SELECT * FROM tblcursos_aseica WHERE tblcursos_aseica.intEstado = 1 ORDER BY tblcursos_aseica.intCalen";
...
<script> function asegurar2() { rc = confirm("¿Seguro lo desea Pasarlo?");  return rc; } </script>
...
<h3 class="panel-title">Lista de Cursos por Realizar en Aseica</h3><br>
<br>
<div class="col-sm-6">
<a href="cursos_realizar_add.php" class="btn btn-success col-sm-12">Habilitar Nuevo Curso</a>
</div>
...
<th data-priority="5">Partici.<br> Notifica</th>
<th data-priority="5">Partici.<br> Pagado</th>
<th data-priority="5">Partici.<br> x Pagar</th>
<th data-priority="5">Par. Recha.</th>
<th data-priority="2">Total Par.</th>
<th data-priority="3">Estado</th>
<th data-priority="2">Lista<br> Participantes</th>
<th data-priority="4">Pasar<br> Ejecución</th>
<th data-priority="4">Pasar<br> Rechazado</th>
<th data-priority="4">Pasar<br> Finalizado</th>
...
<td><a href="cursos_realizar_lista.php?li=<?php echo $row_cursos['intOferta']; ?>&cal=<?php echo $row_cursos['intCalen']; ?>" class="btn btn-icon btn-warning2"><i class="fa-edit"></i></a></td>
<td><a href="cursos_realizar_eje.php?id=<?php echo $row_cursos['idCurso']; ?>" onclick="javascript:return asegurar2();" class="btn btn-icon btn-warning3"><i class="fa-edit"></i></a></td>
<td><a href="cursos_realizar_rech.php?id=<?php echo $row_cursos['idCurso']; ?>" onclick="javascript:return asegurar2();" class="btn btn-icon btn-warning4"><i class="fa-remove"></i></a></td>
<td><a href="cursos_realizar_fina.php?id=<?php echo $row_cursos['idCurso']; ?>" onclick="javascript:return asegurar2();" class="btn btn-icon btn-warning5"><i class="fa-remove"></i></a></td>
...
<h3 class="panel-title">No Hay Ofertas</h3>
