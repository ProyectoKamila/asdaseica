...
$oferta_Seleccionada = ObtNombOferAcade($row_registro['intOferta'])." a efectuarse el ".FecDelCalen($row_registro['intCalendario']);
...
<p>Nuestra Dirección Académica ha confirmado que el depósito/Transferencia correspondiente a su inscripción en nuestro curso de '.$oferta_Seleccionada.' no existe un registro de transacción bancaria con los Siguientes datos:</p>
...
<p> Escriba el número del depósito o transferencia en el enlace <a href="http://www.aseica.com.ve/pago2.php?id='.$numr.'&parti='.$numr2.'&pa='.$id_Pre_inscrip.'&cle0='.$row_listas2['intCurso'].'&lig='.$_GET['pa'].'">NOTIFICASIÓN DE PAGO</a></p>
...
<META HTTP-EQUIV="Refresh" CONTENT="1; URL=cursos_realizar_lista_veri_pagos.php?li=<?php echo $row_listas2['intCurso']; ?>">
