...
<div class="about-intro-wrap pull-left">
  ...
  <div class="bread-heading">
    <h1>Plataforma al &Eacute;xito</h1>
  </div>                        
  </div>
  </div>
  </div> 
...
<div class="container">
  ...
  <!--<img alt="<?php//  echo$row_plataforma['strTitulo']; ?>" class="img-responsive" src="imagenes/plataforma/<?php// echo $row_plataforma['txtImagen_pqn']; ?>" />-->
  </div>
    
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    
  <div class="dept-subtitle-tabs">
    <h3><?php echo $row_plataforma['strTitulo']; ?></h3>
  </div>
    
  <?php if ($row_plataforma['txtImagen_01'] != '') { ?>
  <img alt="<?php echo $row_plataforma['strTitulo']; ?>" class="img-responsive" src="imagenes/plataforma/<?php echo $row_plataforma['txtImagen_01']; ?>" />
  <?php } if ($row_plataforma['txtTexto_01'] != '') { ?>
  <p><?php echo $row_plataforma['txtTexto_01']; ?></p>
  <?php } if ($row_plataforma['txtImagen_02'] != '') { ?>
  <img alt="<?php echo $row_plataforma['strTitulo']; ?>" class="img-responsive" src="imagenes/plataforma/<?php echo $row_plataforma['txtImagen_02']; ?>" />
  <?php } if ($row_plataforma['txtTexto_02'] != '') { ?>
  <p><?php echo $row_plataforma['txtTexto_02']; ?></p>
  <?php } ?>
...
<?php mysql_free_result($plataforma); ?>
